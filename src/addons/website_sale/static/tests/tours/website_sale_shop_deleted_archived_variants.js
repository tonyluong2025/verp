verp.define('website_sale.tour_shop_deleted_archived_variants', function (require) {
'use strict';
...
[
    {
        ...
        trigger: '.oe_product_cart .oe-currency-value:contains("1.00")',
    },
    {
    ...
    },
    {
        ...
        trigger: '.oe-currency-value:contains("31.00")'
    },
    {
    ...
    },
    {
        ...
        trigger: '.js_main_product.css-not-available .css_not_available_msg:contains("This combination does not exist.")'
    },
    {

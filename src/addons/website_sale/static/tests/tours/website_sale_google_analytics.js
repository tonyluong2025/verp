verp.define('website_sale.google_analytics', function (require) {
'use strict';
...
[
    ...
    },
    {
        ...
        extraTrigger: 'body:not([view-event-id])',
        trigger: 'ul.js-add-cart-variants ul.list-inline li:has(label.active) + li:has(label) input',
    },
    {
...
[
    ...
    },
    {
        ...
        extraTrigger: 'body[cart-event-id]',

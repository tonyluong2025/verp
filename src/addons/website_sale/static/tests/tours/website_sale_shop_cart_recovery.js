verp.define('website_sale.tour_shop_cart_recovery', function (require) {
'use strict';
...
[
    ...
    },
    {
        ...
        run: function () {
            ...
            var url = "/web#action=sale.action_orders&viewType=form&id=" + orderId;
    ...
    },
    {
        ...
        extraTrigger: 'p:contains("This is your current cart")',

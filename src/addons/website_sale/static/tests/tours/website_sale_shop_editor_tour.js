...
tour.register('shop_editor', {
    ...
    extraTrigger: "div.o_pricelist_dropdown a[data-toggle=dropdown][aria-expanded=true]",
    content: "Click somewhere else in the shop.",
}, {
    trigger: "div.o_pricelist_dropdown a[data-toggle=dropdown]",
    extraTrigger: "div.o_pricelist_dropdown a[data-toggle=dropdown][aria-expanded=false]",

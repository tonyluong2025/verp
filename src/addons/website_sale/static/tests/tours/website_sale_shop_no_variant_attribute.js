verp.define('website_sale.tour_shop_no_variant_attribute', function (require) {
'use strict';
...
[
    ...
    {
        content: "check price",
        trigger: '.oe-currency-value:contains("1.00")',
        run: function () {},
    },
    {
        content: "add to cart",

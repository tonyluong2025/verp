verp.define('wysiwyg.widgets.AltDialog', function (require) {
'use strict';
...
var AltDialog = Dialog.extend({
    ...
    init: function (parent, options, media) {
        ...
        this.tagTitle = (title).replace(allEscQuots, '"');
    },
    ...
    save: function () {
        ...
        $(this.media).trigger('contentChanged');
        this.finalData = this.media;

verp.define('web_editor.base', function (require) {
'use strict';
...
return {
     ...
     */
    ready: function () {
        return Promise.all([domReady, session.isBound, ajax.loadXML()]);
    },
};
});
...
verp.define('web_editor.context', function (require) {
'use strict';
...
verp.define('web_editor.ready', function (require) {
'use strict';

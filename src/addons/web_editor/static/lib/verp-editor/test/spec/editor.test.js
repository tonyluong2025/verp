...
X[]
        ...
        describe('Selection not collapsed', () => {
            ...
            it('should empty an inline unremovable but remain in it', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p>ab<b class="oe-unremovable">[cd]</b>ef</p>',
                    stepFunction: deleteForward,
                    contentAfter: '<p>ab<b class="oe-unremovable">[]\u200B</b>ef</p>',
                });
            });
        });
    });
        ...
        describe('Selection collapsed', () => {
            describe('Basic', () => {
                ...
                it('should remove a media element', async () => {
                    await testEditor(BasicEditor, {
                        contentBefore: `<p>abc</p><div class="o-image"></div><p>[]def</p>`,
                        stepFunction: async editor => {
                            await deleteBackward(editor);
                        },

import { URL_REGEX, URL_REGEX_WITH_INFOS } from '../../src/VerpEditor.js';
...
describe('urlRegex', () => {
    ...
    it('should match 1234-abc.runbot007.theverp.com/web#id=3&menuId=221', () => {
        const url = '1234-abc.runbot007.theverp.com/web#id=3&menuId=221';
        const text = `abc ${url} abc`;
        const match = text.match(URL_REGEX);
        chai.expect(match[0]).to.be.equal(url);
    });
    it('should match https://1234-abc.runbot007.theverp.com/web#id=3&menuId=221', () => {
        const url = 'https://1234-abc.runbot007.theverp.com/web#id=3&menuId=221';
        const text = `abc ${url} abc`;
        const match = text.match(URL_REGEX);
        chai.expect(match[0]).to.be.equal(url);
    });

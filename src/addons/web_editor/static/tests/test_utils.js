verp.define('web_editor.testUtils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.testUtils');
var VerpEditorLib = require('@web_editor/../lib/verp-editor/src/VerpEditor');
...
const COLOR_PICKER_TEMPLATE = `
    <colorpicker>
        <div class="o-colorpicker-section" data-name="theme" data-display="Theme Colors" data-icon-class="fa fa-flask">
        ...
        <div class="o-colorpicker-section" data-name="transparent-grayscale" data-display="Transparent Colors" data-icon-class="fa fa-eye-slash">
            <button class="o-btn-transparent"/>
        ...
        <div class="o-colorpicker-section" data-name="common" data-display="Common Colors" data-icon-class="fa fa-paint-brush"/>
    </colorpicker>
`;
const SNIPPETS_TEMPLATE = `
    <h2 id="snippetsMenu">Add blocks</h2>
    <div id="oScroll">
        <div id="snippetStructure" class="o-panel">
            <div class="o-panel-header">First Panel</div>
...
MockServer.include({
    ...
    async _performRpc(route, args) {
        if (args.model === "ir.ui.view" && args.method === 'renderPublicAsset') {
    ...
    return _.defaults({}, data, {
        ...
        'ir.attachment': {
            ...
            records: [{
                ...
                isPublic: true,
                accessToken: false,
                imageSrc: '/web/image/123/transparent.png',
                image_width: 256,
                image_height: 256,
            }],
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (VerpEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = VerpEditorLib.childNodeIndex(point.node) + 1;

...
const ForecastColumnQuickCreate = Widget.extend({
     ...
     */
    _addColumn: function () {
        this.triggerUp('forecastKanbanAddColumn', {});
    },

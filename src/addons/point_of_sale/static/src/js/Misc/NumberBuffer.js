verp.define('point_of_sale.NumberBuffer', function(require) {
    'use strict';
    ...
    class NumberBuffer extends EventBus {
         ...
         */
        activate() {
            this.defaultDecimalPoint = _t.database.parameters.decimalPoint;
        ...
        _setUp() {
            ...
            this.maxTimeBetweenKeys = this.config.useWithBarcode
                ? BarcodeEvents.maxTimeBetweenKeysInMs
                : 0;
        }

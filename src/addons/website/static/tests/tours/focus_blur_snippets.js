verp.define('website.tour.focus_blur_snippets', function (require) {
'use strict';
...
function clickAndCheck(blockID, expected) {
    ...
    return [{
        ...
        trigger: blockID
            ? `.oe-overlay.ui-draggable:eq(${blockData.overlayIndex}).oe-active`
            : `#oe-manipulators:not(:has(.oe-active))`,
...
tour.register('focus_blur_snippets', {
...
}, [
    {
        ...
        trigger: 'body',
        run: function () {
            ajax.loadJS('/website/static/tests/tourUtils/focus_blur_snippets_options.js').then(function () {
    ...
    },
    {
        ...
        trigger: '#snippetStructure .oe-snippet:has(.oe-snippet-body.s_focusblur) .oe-snippet-thumbnail',
        extraTrigger: 'body.focus_blur_snippets_options_loaded',

verp.define('website.sDynamicSnippetCarousel', function (require) {
'use strict';
...
const DynamicSnippetCarousel = DynamicSnippet.extend({
    selector: '.s-dynamic-snippet-carousel',
    ...
    init: function () {
        ...
        this.templateKey = 'website.sDynamicSnippet.carousel';
    },
...
publicWidget.registry.dynamicSnippetCarousel = DynamicSnippetCarousel;

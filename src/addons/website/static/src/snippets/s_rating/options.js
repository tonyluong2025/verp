verp.define('website.sRatingOptions', function (require) {
'use strict';
...
options.registry.Rating = options.Class.extend({
    ...
    customIcon: async function (previewMode, widgetValue, params) {
        return new Promise(resolve => {
            ...
            dialog.on('save', this, function (attachments) {
                ...
                const $activeIcons = this.$target.find('.s-rating-active-icons > i');
                const $inactiveIcons = this.$target.find('.s-rating-inactive-icons > i');
    ...
    _computeWidgetState: function (methodName, params) {
        switch (methodName) {
            ...
            case 'activeIconsNumber': {
                this.nbActiveIcons = this.$target.find('.s-rating-active-icons > i').length;
                return this.nbActiveIcons;
            }
            case 'totalIconsNumber': {
                this.nbTotalIcons = this.$target.find('.s-rating-icons i').length;
    ...
    _createIcons: function () {
        const $activeIcons = this.$target.find('.s-rating-active-icons');
        const $inactiveIcons = this.$target.find('.s-rating-inactive-icons');
        this.$target.find('.s-rating-icons i').remove();

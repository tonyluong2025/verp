verp.define('account.dashboard.setup.tour', function (require) {
    "use strict";
    ...
    }, [tour.stepUtils.showAppsMenuItem(),
    {
        ...
        trigger: '.o-data-row:first',
        extraTrigger: '.breadcrumb',
    }, {
        trigger: '.o-control-panel button:contains("' + _t('Print') + '")',
    }, {
        trigger: '.o-control-panel .dropdown-menu a:contains("' + _t('Invoices without Payment') + '")',
    }, {
        trigger: 'iframe .o-report-layout-standard h2',
        ...
        trigger: 'iframe .o-report-layout-standard #informations div strong',

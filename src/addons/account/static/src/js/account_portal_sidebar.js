verp.define('account.AccountPortalSidebar', function (require) {
'use strict';
...
publicWidget.registry.AccountPortalSidebar = PortalSidebar.extend({
    selector: '.o-portal-invoice-sidebar',
    events: {
        'click .o-portal-invoice-print': '_onPrintInvoice',
    },
    ...
    start: function () {
        ...
        var $invoiceHtml = this.$el.find('iframe#invoiceHtml');

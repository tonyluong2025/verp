...
export class NotificationGroup extends Component {
    ...
    /**
     * @returns {mail.notificationGroup}
     */
    get group() {
        return this.messaging && this.messaging.models['mail.notificationGroup'].get(this.props.notificationGroupLocalId);
    }
     ...
     */
    image() {
        if (this.group.notificationType === 'email') {

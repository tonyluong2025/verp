...
export class ChatWindow extends Component {
    ...
    constructor(...args) {
        ...
        /**
         * Reference of the autocomplete input (newMessage chat window only).
     ...
     */
    get chatWindow() {
        return this.messaging && this.messaging.models['mail.chatWindow'].get(this.props.chatWindowLocalId);
    }

    /**
     * Get the content of placeholder for the autocomplete input of
     * 'newMessage' chat window.
     *
     * @returns {string}
     */
    ...
    /**
     * Called when typing in the autocomplete input of the 'newMessage' chat
     * window.
     *
     * @private
     * @param {Object} req

...
export class MessageList extends Component {
    ...
    setup() {
         ...
         * auto_scroll feature when the scroll was not made by the user.
         */
     ...
     */
    get threadView() {
        return this.messaging && this.messaging.models['mail.threadView'].get(this.props.threadViewLocalId);
    }
     ...
     *
     * @private
     * @param {mail.message.view} messageView
     */

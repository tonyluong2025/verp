...
QUnit.test('simplest layout', async function (assert) {
    ...
    assert.ok(
        attachmentImage.classList.contains('o-image'),
        "attachment should have o-image classname (required for mimetype.scss style)"
    );
    assert.strictEqual(

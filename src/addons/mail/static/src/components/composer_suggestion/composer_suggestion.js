...
export class ComposerSuggestion extends Component {
    ...
    get isCannedResponse() {
        return this.props.modelName === "mail.cannedResponse";
    }
    ...
    get isCommand() {
        return this.props.modelName === "mail.channelCommand";
    }
    ...
    title() {
        ...
        if (this.isCommand) {
            return _.str.sprintf("%s: %s", this.record.label, this.record.help);
        }
        if (this.isPartner) {

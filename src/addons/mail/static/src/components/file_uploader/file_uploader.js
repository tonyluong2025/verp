...
export class FileUploader extends Component {
    ...
    get composerView() {
        return this.messaging.models['mail.composer.view'].get(this.props.composerViewLocalId);
    }
    ...
    _createFormData({ composer, file, thread }) {
        ...
        formData.append('csrfToken', core.csrfToken);
        formData.append('isPending', Boolean(composer));
        formData.append('threadId', thread && thread.id);
        formData.append('threadModel', thread && thread.model);

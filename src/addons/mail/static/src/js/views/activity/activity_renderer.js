...
/**
 * Owl Component Adapter for ActivityRecord which is KanbanRecord (Verp Widget)
...
/**
 * Owl Component Adapter for KanbanColumnProgressBar (Verp Widget)
...
class ActivityRenderer extends AbstractRendererOwl {
    constructor(parent, props) {
        ...
        this.qweb.addTemplate(utils.jsonNodeToXml(props.templates));
     ...
     */
    get activityResIds() {
        const copiedActivityResIds = Array.from(this.props.activityResIds)
     ...
     */
    get activityTypeIds() {
        const activities = Object.values(this.props.groupedActivities);
    ...
    getProgressBarColumnState(typeId) {
        ...
        for (let activities of Object.values(this.props.groupedActivities)) {

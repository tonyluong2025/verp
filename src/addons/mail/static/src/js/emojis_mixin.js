 ...
 * - format text and wrap the emojis around <span class="o-mail-emoji"> to make them look nicer
 *
...
export default {
    ...
    /**
     * This method is used to wrap emojis in a text message with <span class="o-mail-emoji">
    ...
    /**
     * Adapted from qweb2.js#htmlEscape to avoid formatting '&'
     *
     * @param {String} s
     * @private
     */
    ...
    _wrapEmojis: function (message) {
        emojis.forEach(function (emoji) {
            message = message.replace(
                ...
                '<span class="o-mail-emoji">' + emoji.unicode + '</span>'
            );
        });

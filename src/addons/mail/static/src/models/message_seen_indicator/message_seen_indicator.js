...
function factory(dependencies) {
    ...
    class MessageSeenIndicator extends dependencies['mail.model'] {
        ...
        static recomputeFetchedValues(channel = undefined) {
            ...
            const indicators = this.messaging.models['mail.messageSeenIndicator'].all(indicatorFindFunction);
        ...
        _computePartnersThatHaveFetched() {
            ...
            const otherPartnersThatHaveFetched = this.thread.partnerSeenInfos
                .filter(partnerSeenInfo =>
                     ...
                     * @see mail.threadPartnerSeenInfo:partnerId field
                     * FIXME task-2278551
                     */
    ...
    MessageSeenIndicator.modelName = 'mail.messageSeenIndicator';
...
registerNewModel('mail.messageSeenIndicator', factory);

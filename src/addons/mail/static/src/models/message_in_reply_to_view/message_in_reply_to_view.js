...
function factory(dependencies) {
    ...
    class MessageInReplyToView extends dependencies['mail.model'] {
        ...
        onClickReply(ev) {
            ...
            const parentMessageView = this.messaging.models['mail.message.view'].findFromIdentifyingData({
    ...
    MessageInReplyToView.modelName = 'mail.messageInReplyToView';

    return MessageInReplyToView;
}

registerNewModel('mail.messageInReplyToView', factory);

...
function factory(dependencies) {
    ...
    Dialog.fields = {
        attachmentViewer: one2one('mail.attachmentViewer', {
            isCausal: true,
            inverse: 'dialog',
            readonly: true,
        }),
        followerSubtypeList: one2one('mail.followerSubtypeList', {
            isCausal: true,
            inverse: 'dialog',
            readonly: true,
        }),
        manager: many2one('mail.dialogManager', {
            inverse: 'dialogs',
            readonly: true,
        }),
        /**
         ...
         * created from @see `mail.dialogManager:open()`.
         */

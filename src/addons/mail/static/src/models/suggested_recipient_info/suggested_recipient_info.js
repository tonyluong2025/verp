...
function factory(dependencies) {
    ...
    class SuggestedRecipientInfo extends dependencies['mail.model'] {
         ...
         */
        _computeName() {
            return this.partner && this.partner.nameOrDisplayName || this.label;
        }
    ...
    SuggestedRecipientInfo.modelName = 'mail.suggestedRecipientInfo';

    return SuggestedRecipientInfo;
}

registerNewModel('mail.suggestedRecipientInfo', factory);

...
function factory(dependencies) {
        ...
        replyTo() {
            ...
            this.message.originThread.update({
                composer: insertAndReplace({
                    isLog: !this.message.isDiscussion && !this.message.isNotification,
                }),
            });
    ...
    MessageView.fields = {
        ...
        */
        composerViewInEditing: one2one('mail.composer.view', {
            inverse: 'messageViewInEditing',
            isCausal: true,
        }),
        /**
         ...
         */
        messageActionList: one2one('mail.messageActionList', {
         ...
         */
        messageActionListWithDelete: one2one('mail.messageActionList', {
         ...
         */
        messageInReplyToView: one2one('mail.messageInReplyToView', {
         ...
         */
        threadView: many2one('mail.threadView', {
            inverse: 'messageViews',
            readonly: true,
        }),
    };
    MessageView.identifyingFields = [['threadView', 'messageActionListWithDelete'], 'message'];
    MessageView.modelName = 'mail.message.view';

    return MessageView;
}

registerNewModel('mail.message.view', factory);

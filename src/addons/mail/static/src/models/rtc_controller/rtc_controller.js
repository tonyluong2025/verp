...
function factory(dependencies) {
    ...
    RtcController.fields = {
        callViewer: one2one('mail.rtcCallViewer', {
        ...
        rtcOptionList: one2one('mail.rtcOptionList', {
    ...
    RtcController.modelName = 'mail.rtcController';

    return RtcController;
}

registerNewModel('mail.rtcController', factory);

...
function factory(dependencies) {
    ...
    class ThreadView extends dependencies['mail.model'] {
         ...
         * loaded, then it may need to autoScroll to last message.
         *
        ...
        _shouldMessageBeSquashed(prevMessage, message) {
            ...
            if (prevMessage.messageType !== 'comment' || message.messageType !== 'comment') {
                return false;
            }
    ...
    ThreadView.fields = {
         ...
         * is visible, it should autoScroll to this new last message.
         *
         ...
         */
        replyingToMessageView: many2one('mail.message.view'),
        /**
         * Determines the Rtc call viewer of this thread.
         */
        rtcCallViewer: one2one('mail.rtcCallViewer', {
        ...
        /**
         * States the `mail.threadCache` currently displayed by `this`.
         */
        threadCache: many2one('mail.threadCache', {
            inverse: 'threadViews',
            readonly: true,
        ...
        /**
         * Determines the `mail.thread.viewer` currently managing `this`.
         */
         ...
         */
        topbar: one2one('mail.threadViewTopbar', {
    ...
    ThreadView.modelName = 'mail.threadView';

    return ThreadView;
}

registerNewModel('mail.threadView', factory);

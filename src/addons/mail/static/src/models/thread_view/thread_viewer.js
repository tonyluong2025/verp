...
function factory(dependencies) {
    ...
    class ThreadViewer extends dependencies['mail.model'] {
         ...
         * @param {mail.threadCache} threadCache
         */
        ...
        /**
         * @private
         * @returns {mail.thread.viewer|undefined}
         */
        _computeThreadView() {
    ...
    ThreadViewer.fields = {
        ...
        /**
         * States the `mail.threadCache` that should be displayed by `this`.
         */
        ...
        /**
         * States the `mail.threadView` currently displayed and managed by `this`.
         */
    ...
    ThreadViewer.modelName = 'mail.thread.viewer';

    return ThreadViewer;
}

registerNewModel('mail.thread.viewer', factory);

...
/**
 * This tour depends on data created by javascript test in charge of launching it.
 * It is not intended to work when launched from interface. It is needed to test
 * an action (action manager) which is not possible to test with QUnit.
 * @see mail/tests/test_mail_full_composer.js
 */
tour.register('mail/static/tests/tours/mail_full_composer_test_tour.js', {
    ...
    extraTrigger: '.o_AttachmentCard:not(.o-isUploading)' // waiting the attachment to be uploaded
}, {
    ...
    trigger: '.oe-form-field[name="body"]',
    run() {
        const bodyContent = document.querySelector('.oe-form-field[name="body"]').textContent;
    ...
    trigger: '.o-field-widget[name="template_id"] input',
}, {

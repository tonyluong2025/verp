verp.define('sale.product_configurator_tests', function (require) {
    "use strict";
        ...
        beforeEach: function () {
            this.data = {
                ...
                line: {
                    ...
                    records: [
                        {id: 1, sequence: 4, productId: 3, orderId: 1},
                        {id: 2, sequence: 14, productId: 4, orderId: 1},
                    ]
                },
                product: {
                    fields: {
                ...
                archs: {
                    'line,false,list': `
                        <tree editable="bottom">
                            ...
                            <field name="productId" widget="product_configurator"/>
                        </tree>`,
                },
                resId: 1,
                viewOptions: {

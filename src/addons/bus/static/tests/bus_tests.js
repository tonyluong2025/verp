verp.define('web.bus_tests', function (require) {
"use strict";
...
QUnit.module('Bus', {
    ...
    QUnit.test('notifications received from the longpolling channel', async function (assert) {
        ...
        await testUtils.mock.addMockEnvironment(parent, {
            ...
            services: {
                ...
                localStorage: LocalStorageServiceMock,
            },
        ...
        widget.call('busService', 'onNotification', this, function (notifications) {
            assert.step('notification - ' + notifications.toString());
        });
        widget.call('busService', 'addChannel', 'lambda');
    ...
    QUnit.test('longpolling restarts when connection is lost', async function (assert) {
        ...
        legacyRegistry.add("busService", BusService);
        legacyRegistry.add("localStorage", LocalStorageServiceMock);
        ...
        busService = owl.Component.env.services.busService;
    ...
    QUnit.test('cross tab bus share message from a channel', async function (assert) {
        ...
        master.call('busService', 'onNotification', master, function (notifications) {
            assert.step('master - notification - ' + notifications.toString());
        });
        master.call('busService', 'addChannel', 'lambda');
        ...
        slave.call('busService', 'onNotification', slave, function (notifications) {
            assert.step('slave - notification - ' + notifications.toString());
        });
        slave.call('busService', 'addChannel', 'lambda');
    ...
    QUnit.test('cross tab bus elect new master on master unload', async function (assert) {
        ...
        master.call('busService', '_onUnload');

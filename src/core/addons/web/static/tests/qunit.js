(function () {
    ...
    async function checkModules() {
        ...
        await verp.__DEBUG__.didLogInfo;
        const info = verp.__DEBUG__.jsModules;
    ...
    QUnit.begin(function () {
        if (verp.__DEBUG__.services["@web/core/errors/error_utils"]) {
            const errorUtils = verp.__DEBUG__.services["@web/core/errors/error_utils"];

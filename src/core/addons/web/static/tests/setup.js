...
function checkGlobalObjectsIntegrity() {
    const objects = [
        [session, ["userContext", "currencies"]],
        [_t, ["database.multiLang", "database.parameters"]],
    ];
...
export async function setupTests() {
    ...
    const templatesUrl = `/web/webclient/qweb/${new Date().getTime()}?bundle=web.assetsQweb`;
    ...
    window.__VERP_TEMPLATES__ = templates;

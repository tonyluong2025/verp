...
QUnit.test("close popover when component is unmounted", async (assert) => {
    ...
    assert.containsN(fixture, ".o-popover", 2);
    assert.containsOnce(fixture, ".o-popover #comp1");
    assert.containsOnce(fixture, ".o-popover #comp2");

    comp1.destroy();
    await nextTick();

    assert.containsOnce(fixture, ".o-popover");
    assert.containsNone(fixture, ".o-popover #comp1");
    assert.containsOnce(fixture, ".o-popover #comp2");
    ...
    assert.containsNone(fixture, ".o-popover #comp1");
    assert.containsNone(fixture, ".o-popover #comp2");
});

...
const mainComponents = registry.category("mainComponents");
...
QUnit.module("Tooltip hook", () => {
    QUnit.test("basic rendering", async (assert) => {
        ...
        assert.containsNone(parent, ".o-popover_container .o-popover");
        ...
        simulateTimeout();
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(
            parent.el.querySelector(".o-popover_container .o-popover").innerText,
            "hello"
        );
    ...
    QUnit.test("rendering with several tooltips", async (assert) => {
        ...
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "tooltip 1");
        ...
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "tooltip 2");
    });
    ...
    QUnit.test("positionning", async (assert) => {
        ...
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "default");
        assert.hasClass(parent.el.querySelector(".o-popover"), "o-popper-position--bm");

        // top
        parent.el.querySelector("button.top").dispatchEvent(new Event("mouseenter"));
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "top");
        assert.hasClass(parent.el.querySelector(".o-popover"), "o-popper-position--tm");

        // right
        parent.el.querySelector("button.right").dispatchEvent(new Event("mouseenter"));
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "right");
        assert.hasClass(parent.el.querySelector(".o-popover"), "o-popper-position--rm");

        // bottom
        parent.el.querySelector("button.bottom").dispatchEvent(new Event("mouseenter"));
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "bottom");
        assert.hasClass(parent.el.querySelector(".o-popover"), "o-popper-position--bm");
        ...
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-popover");
        assert.strictEqual(parent.el.querySelector(".o-popover").innerText, "left");
        assert.hasClass(parent.el.querySelector(".o-popover"), "o-popper-position--lm");
    });
    ...
    QUnit.test("tooltip with a template, no info", async (assert) => {
        ...
        assert.containsNone(parent, ".o-popover_container .o-tooltip");
        parent.el.querySelector("button").dispatchEvent(new Event("mouseenter"));
        await nextTick();
        assert.containsOnce(parent, ".o-popover_container .o-tooltip");

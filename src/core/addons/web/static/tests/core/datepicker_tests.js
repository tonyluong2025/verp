...
import { createComponent } from 'web.testUtils';
...
QUnit.module("Components", () => {
    ...
    QUnit.test("basic rendering", async function (assert) {
        ...
        assert.containsOnce(picker, "input.o-input.o-datepicker-input");
        assert.containsOnce(picker, "span.o-datepicker-button");
        assert.containsNone(document.body, "div.bootstrap-datetimepicker-widget");

        const input = picker.el.querySelector("input.o-input.o-datepicker-input");
    ...
    QUnit.test("pick a date", async function (assert) {
        ...
        const input = picker.el.querySelector(".o-datepicker-input");
    ...
    QUnit.test("enter a date value", async function (assert) {
        ...
        await triggerEvent(picker.el, ".o-datepicker-input", "change");
    ...
    QUnit.test("Datepicker works with norwegian locale", async (assert) => {
        ...
        const target = getFixture();
        const input = target.querySelector(".o-datepicker-input");
    ...
    QUnit.test('custom filter date', async function (assert) {
        ...
        await editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'date_field');
        const valueInput = cfi.el.querySelector('.o-generator-menu-value .o-input');

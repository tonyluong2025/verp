verp.define('web.dropdown_menu_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {
        ...
        QUnit.test('simple rendering and basic interactions', async function (assert) {
            ...
            const itemEls = dropdown.el.querySelectorAll('.o-menu-item > .dropdown-item');
            ...
            const dropdownElements = dropdown.el.querySelectorAll('.o-menu-item *');
        ...
        QUnit.test('click on an item without options should toggle it', async function (assert) {
            ...
            const firstItemEl = dropdown.el.querySelector('.o-menu-item > a');
        ...
        QUnit.test('click on an item should not change url', async function (assert) {
            ...
            await testUtils.dom.click(dropdown.el.querySelector('button'));
            await testUtils.dom.click(dropdown.el.querySelector('.o-menu-item > a'));
        ...
        QUnit.test('click on an option should trigger the event "item_option_clicked" with appropriate data', async function (assert) {
            ...
            // open dropdown menu
            await testUtils.dom.click(dropdown.el.querySelector('button'));
            assert.containsN(dropdown, '.dropdown-divider, .o-menu-item', 3);

            // open menu options of first item
            await testUtils.dom.click(dropdown.el.querySelector('.o-menu-item > a'));
            let optionELs = dropdown.el.querySelectorAll('.o-menu-item .o_item_option > a');

            // click on first option
            await testUtils.dom.click(optionELs[0]);
            assert.hasClass(dropdown.el.querySelector('.o-menu-item > a'), 'selected');
            optionELs = dropdown.el.querySelectorAll('.o-menu-item .o_item_option > a');
            ...
            await testUtils.dom.click(optionELs[1]);
            assert.doesNotHaveClass(dropdown.el.querySelector('.o-menu-item > a'), 'selected');
            optionELs = dropdown.el.querySelectorAll('.o-menu-item .o_item_option > a');
        ...
        QUnit.test('keyboard navigation', async function (assert) {
            ...
            assert.strictEqual(document.activeElement, dropdown.el.querySelector('.o-menu-item a'));
            ...
            assert.strictEqual(dropdown.el.querySelector('.o-menu-item a'), document.activeElement);
            assert.containsNone(dropdown, '.o_item_option');
        ...
        QUnit.test('interactions between multiple dropdowns', async function (assert) {
            ...
            await testUtils.dom.click(menu2.querySelector('.o-menu-item a'));
            await testUtils.dom.click(menu1.querySelector('button'));
        ...
        QUnit.test("dropdown doesn't get close on mousedown inside and mouseup outside dropdown", async function (assert) {
            ...
            const firstItemEl = menu.querySelector(".o-menu-item > a");
            // open options menu
            await testUtils.dom.click(firstItemEl);
            assert.hasClass(firstItemEl.querySelector("i"), "o_icon_right fa fa-caret-down");

            // force the focus inside the dropdown item and click outside
            firstItemEl.parentElement.querySelector(".o-menu-item_options .o_item_option a").focus();

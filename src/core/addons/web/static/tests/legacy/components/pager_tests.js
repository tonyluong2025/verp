verp.define('web.pager_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {}, function () {
        ...
        QUnit.test('edit the pager', async function (assert) {
            ...
            await testUtils.dom.click(pager.el.querySelector('.o-pager-value'));
        ...
        QUnit.test('pager disabling', async function (assert) {
            ...
            assert.strictEqual(pager.el.querySelector('.o-pager-value').tagName, 'SPAN',
            ...
            assert.strictEqual(pager.el.querySelector('.o-pager-value').tagName, 'INPUT',

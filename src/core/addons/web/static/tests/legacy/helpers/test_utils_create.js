verp.define('web.test_utils_create', function (require) {
    "use strict";
    ...
    const customHooks = require('web.customHooks');
    ...
    async function createView(params) {
        ...
        const webClient = Object.assign(document.createElement('div'), {
            className: params.touchScreen ? 'o-web-client o_touch_device' : 'o-web-client',
        });
        const actionManager = Object.assign(document.createElement('div'), {
            className: 'o-action-manager',
        });
        ...
        const viewOptions = Object.assign({
            ...
            view: viewInfo,
            modelName: modelName,
            ids: 'resId' in params ? [params.resId] : undefined,
            currentId: 'resId' in params ? params.resId : undefined,
     ...
     *      the DOM. Also, RPCs and uncaught VerpEvent will be logged
     * @returns {HTMLElement}
     */

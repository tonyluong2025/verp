verp.define('web.test_utils_form', function (require) {
"use strict";
...
function clickEdit(form) {
    return testUtilsDom.click(form.$buttons.find('.o-form-button_edit'));
}
...
function clickSave(form) {
    return testUtilsDom.click(form.$buttons.find('.o-form-button-save'));
}
...
function clickCreate(form) {
    return testUtilsDom.click(form.$buttons.find('.o-form-button_create'));
}
...
function clickDiscard(form) {
    return testUtilsDom.click(form.$buttons.find('.o-form-button_cancel'));
}

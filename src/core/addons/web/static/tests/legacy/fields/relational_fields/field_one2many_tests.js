                ...
                arch: `
                    <form>
                        ...
                        <field name="p">
                            <tree>
                                <field name="foo"/>
                                <button name="abc" string="Do it" class="some_button" attrs="{'column_invisible': [('parent.productId', '=', false)]}"/>
                            </tree>
                        </field>
                    </form>`,
                resId: 1,
                    ...
                    <form>
                        ...
                        <field name="p">
                            <tree>
                                ...
                                <button name="abc2" string="Do it 2" class="some_button2" attrs="{'column_invisible': [('parent.productId', '!=', false)]}"/>
                                <field name="foo"/>
                                <button name="abc3" string="Do it 3" class="some_button3" attrs="{'column_invisible': [('parent.productId', '!=', false)]}"/>

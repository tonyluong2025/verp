verp.define('web.basic_fields_tests', function (require) {
"use strict";
...
QUnit.module('basicFields', {
        ...
        this.data = {
            partner: {
                fields: {
                    ...
                    currencyId: {string: "Currency", type: "many2one", relation: "currency", searchable: true},
                ...
                {id: 5, bar: false, foo: "blop", int_field: -4, qux: 9.1, currencyId: 1, monetary: 99.9}],
                onchanges: {},
            },
            team: {
                fields: {
                    partnerIds: { string: "Partner", type: "one2many", relation: 'partner' },
                },
                records: [{
                    id: 1,
                    partnerIds: [5],
    ...
    QUnit.test('boolean field in form view', async function (assert) {
        ...
        await testUtils.dom.click(form.$('.o-field-boolean input:checked'));
        ...
        await testUtils.dom.click(form.$('.o-form-view label:first'));
        assert.containsOnce(form, '.o-field-boolean input:checked',
            "checkbox should now be checked");
        ...
        await testUtils.dom.triggerEvents(form.$('.o-field-boolean input'), [
            "focusin",
    ...
    QUnit.test('boolean field in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector) .custom-checkbox input').length, 5,
            "should have 5 checkboxes");
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector) .custom-checkbox input:checked').length, 4,
            "should have 4 checked input");

        // Edit a line
        var $cell = list.$('tr.o-data-row:has(.custom-checkbox input:checked) td:not(.o-list-record-selector)').first();
        ...
        $cell = list.$('tr.o-data-row:has(.custom-checkbox input:not(:checked)) td:not(.o-list-record-selector)').first();
        ...
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector) .custom-checkbox input:checked').length, 3,
    ...
    QUnit.test('readonly boolean field', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-boolean input:checked',
            "checkbox should be checked");
        assert.containsOnce(form, '.o-field-boolean input:disabled',
        ...
        await testUtils.dom.click(form.$('.o-field-boolean label'));
    ...
    QUnit.test('boolean field is editable in an editable form', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-boolean input:enabled',
    ...
    QUnit.test('use boolean toggle widget in form view', async function (assert) {
        ...
        var form = await createView({
            ...
            model: 'partner',
            data: this.data,
            arch: '<form><field name="bar" widget="booleanToggle"/></form>',
            resId: 2,
        });

        assert.containsOnce(form, ".custom-checkbox.o-boolean-toggle", "Boolean toggle widget applied to boolean field");
        assert.containsOnce(form, ".custom-checkbox.o-boolean-toggle .fa-check-circle",
            "Boolean toggle should have fa-check-circle icon");

        await testUtils.dom.click(form.$('.o-field-widget[name=bar]'));
        assert.containsOnce(form, ".custom-checkbox.o-boolean-toggle .fa-times-circle",
    ...
    QUnit.test('boolean toggle widget is not disabled in readonly mode', async function (assert) {
        ...
        assert.containsOnce(form, ".custom-checkbox.o-boolean-toggle", "Boolean toggle widget applied to boolean field");
        assert.notOk(form.$('.o-boolean-toggle input')[0].checked);
        await testUtils.dom.click(form.$('.o-boolean-toggle'));
        assert.ok(form.$('.o-boolean-toggle input')[0].checked);
        form.destroy();
    });
    ...
    QUnit.test('boolean toggle widget is disabled with a readonly attribute', async function (assert) {
        ...
        const form = await createView({
            ...
            model: 'partner',
            data: this.data,
            arch: '<form><field name="bar" widget="booleanToggle" readonly="1"/></form>',
            resId: 5,
        });

        assert.containsOnce(form, ".custom-checkbox.o-boolean-toggle", "Boolean toggle widget applied to boolean field");
        await testUtils.dom.click(form.$buttons.find('.o-form-button_edit'));
        assert.notOk(form.$('.o-boolean-toggle input')[0].checked);
        await testUtils.dom.click(form.$('.o-boolean-toggle'));
        assert.notOk(form.$('.o-boolean-toggle input')[0].checked);
        form.destroy();
    ...
    QUnit.test('use toggle_button in list view', async function (assert) {
        ...
        assert.containsN(list, 'button i.fa.fa-circle.o-toggle-button-success', 4,
            "should have 4 green buttons");
        assert.containsOnce(list, 'button i.fa.fa-circle.text-muted',
            "should have 1 muted button");

        assert.hasAttrValue(list.$('.o-list-view button').first(), 'title',
            "Reported in last payslips", "active buttons should have proper tooltip");
        assert.hasAttrValue(list.$('.o-list-view button').last(), 'title',
        ...
        await testUtils.dom.click(list.$('.o-list-view button').first());
        assert.containsN(list, 'button i.fa.fa-circle.o-toggle-button-success', 3,
    ...
    QUnit.test('toggle_button in form view (edit mode)', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=bar] i.o-toggle-button-success:not(.text-muted)').length,
            1, "should be green");

        // click on the button to toggle the value
        await testUtils.dom.click(form.$('.o-field-widget[name=bar]'));

        assert.strictEqual(form.$('.o-field-widget[name=bar] i.text-muted:not(.o-toggle-button-success)').length,
            1, "should be gray");
        assert.verifySteps([]);
    ...
    QUnit.test('toggle_button in form view with readonly modifiers', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=bar] i.o-toggle-button-success:not(.text-muted)').length,
            1, "should be green");
        assert.ok(form.$('.o-field-widget[name=bar]').prop('disabled'),
    ...
    QUnit.test('numeric field: fields with keydown on numpad decimal key', async function (assert) {
        ...
        this.data.partner.fields.float_factor_field = { string: "Float Factor", type: 'floatFactor' };
        ...
        this.data.partner.records[0].currencyId = 1;
        ...
        // Record edit mode
        await testUtilsDom.click(form.el.querySelector('.o-form-button_edit'));

        // Get all inputs
        const floatFactorField = form.el.querySelector('.o-input[name="float_factor_field"]');
        const floatInput = form.el.querySelector('.o-input[name="qux"]');
        const integerInput = form.el.querySelector('.o-input[name="int_field"]');
        const monetaryInput = form.el.querySelector('.o-input[name="monetary"]');
        const percentageInput = form.el.querySelector('.o-input[name="percentage"]');
        ...
        monetaryInput.dispatchEvent(new KeyboardEvent('keydown', { code: 'NumpadDecimal', key: ',' }));
        await testUtils.nextTick();
        assert.ok(monetaryInput.querySelector('input.o-input') .value.endsWith('🇧🇪🇧🇪'));

        percentageInput.dispatchEvent(new KeyboardEvent('keydown', { code: 'NumpadDecimal', key: '.' }));
        percentageInput.dispatchEvent(new KeyboardEvent('keydown', { code: 'NumpadDecimal', key: ',' }));
        await testUtils.nextTick();
        assert.ok(percentageInput.querySelector('input.o-input').value.endsWith('🇧🇪🇧🇪'));
    ...
    QUnit.test('numeric field: field with type `number` and with keydown on numpad decimal key', async function (assert) {
        ...
        await testUtilsDom.click(form.el.querySelector('.o-form-button_edit'));
        const floatField = form.el.querySelector('.o-input[name="float_field"]');
    ...
    QUnit.test('float field when unset', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), "0.000",
        'Non-set float field should be considered as 0.');
    ...
    QUnit.test('float fields use correct digit precision', async function (assert) {
        ...
        assert.strictEqual(form.$('span.o-field-number:contains(0.4)').length, 1,
    ...
    QUnit.test('float field in list view no widget', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').first().text(), '0.000',
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '18.896',
    ...
    QUnit.test('float field using formula in form view', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '26.000',
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '8.000',
            'The new value should be calculated properly.');
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '33.333',
            'The new value should be calculated properly.');
    ...
    QUnit.test('float field using incorrect formula in form view', async function (assert) {
        ...
        assert.hasClass(form.$('input[name=qux]'),'o-field-invalid',
    ...
    QUnit.test('float field in editable list view', async function (assert) {
        ...
        var zeroValues = list.$('td.o-data-cell').filter(function () {return $(this).text() === '';});
        assert.strictEqual(zeroValues.length, 1,
            'Unset float values should be rendered as empty strings.');

        // switch to edit mode
        var $cell = list.$('tr.o-data-row td:not(.o-list-record-selector)').first();
        await testUtils.dom.click($cell);
        ...
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.strictEqual(list.$('.o-field-widget').first().text(), '18.896',
            'The new value should be rounded properly.');

        list.destroy();
    });

    QUnit.test('do not trigger a fieldChanged if they have not changed', async function (assert) {
        assert.expect(2);
    ...
    QUnit.test('float widget on monetary field', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=monetary]').text(), '9.99',
    ...
    QUnit.test('float field with monetary widget and decimal precision', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').first().text(), '$\u00a0-8.9',
            'The value should be displayed properly.');

        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '-8.9',
            'The input should be rendered without the currency symbol.');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').parent().children().first().text(), '$',
            'The input should be preceded by a span containing the currency symbol.');

        await testUtils.fields.editInput(form.$('.o-field-monetary input'), '109.2458938598598');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '109.2458938598598',
            'The value should not be formated yet.');

        await testUtils.form.clickSave(form);
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '$\u00a0109.2',
            'The new value should be rounded properly.');
    ...
    QUnit.test('float field with type number option', async function (assert) {
        ...
        await testUtils.form.clickEdit(form);
        assert.ok(form.$('.o-field-widget')[0].hasAttribute('type'),
            'Float field with option type must have a type attribute.');
        assert.hasAttrValue(form.$('.o-field-widget'), 'type', 'number',
        ...
        await testUtils.form.clickSave(form);
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget').val(), '123456.789',
            'Float value must be not formatted if input type is number.');
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), '123,456.8',
    ...
    QUnit.test('float field without type number option', async function (assert) {
        ...
        await testUtils.form.clickEdit(form);
        assert.hasAttrValue(form.$('.o-field-widget'), 'type', 'text',
            'Float field with option type must have a text type (default type).');

        await testUtils.fields.editInput(form.$('input[name=qux]'), '123456.7890');
        await testUtils.form.clickSave(form);
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget').val(), '123,456.8',
    ...
    QUnit.test('percentage widget in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').first().text(), '44.4%',
            'The value should be displayed properly.');

        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '44.4',
            'The input should be rendered without the percentage symbol.');
        assert.strictEqual(form.$('.o-field-widget[name=qux] span').text(), '%',
            'The input should be followed by a span containing the percentage symbol.');

        await testUtils.fields.editInput(form.$('.o-field-float-percentage input'), '24');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '24',
            'The value should not be formated yet.');

        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), '24%',
    ...
    QUnit.test('email field in form view', async function (assert) {
        ...
        var $mailtoLink = form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-email > a');
        ...
        // save
        await testUtils.form.clickSave(form);
        $mailtoLink = form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-email > a');
    ...
    QUnit.test('email field in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').length, 5,
            "should have 5 cells");
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').first().text(), 'yop',
            "value should be displayed properly as text");

        var $mailtoLink = list.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-email > a');
        ...
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').first().text(), 'new',
            "value should be properly updated");
        $mailtoLink = list.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-email > a');
        assert.strictEqual($mailtoLink.length, 5,
    ...
    QUnit.test('readonly email field field is properly rerendered after been changed by onchange', async function (assert) {
        ...
        const form = await createView({
            ...
            arch: '<form string="Partners">' +
                '<sheet>' +
                '<group>' +
                '<field name="int_field" onchange="1"/>' + // onchange to update mobile in readonly mode directly
        ...
        assert.strictEqual(form.$('.o-field-email').text(), 'dolores.abernathy@delos',
        ...
        assert.strictEqual(form.$('.o-field-email').text(), 'lara.espin@unknown',
    ...
    QUnit.test("click on email field link don't switch to edit mode", async function (assert) {
        testUtils.mock.patch(fieldRegistry.map.email, {
        ...
        await testUtils.dom.click(form.el.querySelector('.o-field-email a'));
        assert.containsOnce(form.el, ".o-form-readonly", "form view is not in edit mode");

        await testUtils.dom.click(form.el.querySelector('.o-field-email'));
        assert.verifySteps(["A clicked", "DIV clicked"]);
        assert.containsOnce(form.el, ".o-form-editable", "form view is in edit mode");

        form.destroy();
        testUtils.mock.unpatch(fieldRegistry.map.email);
    });
    ...
    QUnit.test('char field in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), 'yop',
            "the value should be displayed properly");
        ...
        // change value in edit mode
        await testUtils.fields.editInput(form.$('input[type="text"].o-field-widget'), 'limbo');

        // save
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), 'limbo',
    ...
    QUnit.test('setting a char field to empty string is saved as a false value', async function (assert) {
        ...
        await testUtils.fields.editInput(form.$('input[type="text"].o-field-widget'), '');
    ...
    QUnit.test('char field with size attribute', async function (assert) {
        ...
        assert.hasAttrValue(form.$('input.o-field-widget'), 'maxlength', '5',
    ...
    QUnit.test('char field in editable list view', async function (assert) {
        ...
        $cell = list.$('tbody td:not(.o-list-record-selector)').first();
        assert.doesNotHaveClass($cell.parent(), 'o-selected-row', 'should not be in edit mode anymore');
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').first().text(), 'brolo',
            "value should be properly updated");
        list.destroy();
    });
    ...
    QUnit.test('char field translatable', async function (assert) {
        ...
        var form = await createView({
            ...
            mockRPC: function (route, args) {
                ...
                if (args.method === "searchRead" && args.model == "ir.translation") {
                    return Promise.resolve([
        ...
        await testUtils.form.clickEdit(form);
        var $button = form.$('input[type="text"].o-field-char + .o-field-translate');
        ...
        assert.containsN($('.modal .o-translation-dialog'), '.translation', 2,
            'two rows should be visible');

        var $enField = $('.modal .o-translation-dialog .translation:first() input');
        assert.strictEqual($enField.val(), 'yop',
            'English translation should be filled');
        assert.strictEqual($('.modal .o-translation-dialog .translation:last() input').val(), 'valeur français',
        ...
        var $foo = form.$('input[type="text"].o-field-char');
        ...
        assert.strictEqual($('.modal .o-translation-dialog .translation:first() input').val(), 'new english value',
    ...
    QUnit.test('html field translatable', async function (assert) {
            ...
            mockRPC: function (route, args) {
                if (route === "/web/dataset/call_button" && args.method === 'translateFields') {
                    ...
                    return Promise.resolve({
                        domain: [],
                        context: {
                            searchDefault_label: 'partner,foo',
                            translationType: 'char',
                            translationShowSrc: true,
                        },
                    });
                }
                if (route === "/web/dataset/callKw/res.lang/get_installed") {
        ...
        // this will not affect the translateFields effect until the record is
        ...
        assert.containsOnce($(document), '.modal', 'a translate modal should be visible');
        assert.containsN($('.modal .o-translation-dialog'), '.translation', 4,
    ...
    QUnit.test('char field does not allow html injections', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), '<script>throw Error();</script>',
    ...
    QUnit.test('input field: change value before pending onchange returns (with fieldDebounce)', async function (assert) {
        ...
        this.data.partner.onchanges = {
            productId: function (obj) {
                obj.int_field = obj.productId ? 7 : false;
            },
        };
    ...
    QUnit.test('input field: change password value', async function (assert) {
        ...
        assert.notEqual(form.$('.o-field-char').text(), "yop",
            "password field value should not be visible in read mode");
        assert.strictEqual(form.$('.o-field-char').text(), "***",
            "password field value should be hidden with '*' in read mode");

        await testUtils.form.clickEdit(form);

        assert.hasAttrValue(form.$('input.o-field-char'), 'type', 'password',
            "password field input should be with type 'password' in edit mode");
        assert.strictEqual(form.$('input.o-field-char').val(), 'yop',
    ...
    QUnit.test('input field: empty password', async function (assert) {
        ...
        assert.hasAttrValue(form.$('input.o-field-char'), 'type', 'password',
            "password field input should be with type 'password' in edit mode");
        assert.strictEqual(form.$('input.o-field-char').val(), '',
    ...
    QUnit.test('input field: set and remove value, then wait for onchange', async function (assert) {
        ...
        this.data.partner.onchanges = {
            productId(obj) {
                obj.foo = obj.productId ? "onchange value" : false;
            },
        };
    ...
    QUnit.test('url widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, 'div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a',
            "should have a anchor with correct classes");
        assert.hasAttrValue(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a'), 'href', 'http://yop',
            "should have proper href link");
        assert.hasAttrValue(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a'), 'target', '_blank',
            "should have target attribute set to _blank");
        assert.strictEqual(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a').text(), 'yop',
            "the value should be displayed properly");
        ...
        // change value in edit mode
        testUtils.fields.editInput(form.$('input[type="text"].o-field-widget'), 'limbo');

        // save
        await testUtils.form.clickSave(form);
        assert.containsOnce(form, 'div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a',
            "should still have a anchor with correct classes");
        assert.hasAttrValue(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a'), 'href', 'http://limbo',
            "should have proper new href link");
        assert.strictEqual(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a').text(), 'limbo',
            'the new value should be displayed');

        await testUtils.form.clickEdit(form);
        testUtils.fields.editInput(form.$('input[type="text"].o-field-widget'), '/web/limbo');

        await testUtils.form.clickSave(form);
        assert.hasAttrValue(form.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a'), 'href', '/web/limbo',
    ...
    QUnit.test('url widget takes text from proper attribute', async function (assert) {
        ...
        assert.strictEqual(form.$('div[name="foo"].o-field-url > a').text(), 'kebeclibre',
    ...
    QUnit.test('url widget: href attribute and website_path option', async function (assert) {
        ...
        assert.strictEqual(form.$('div[name="url1"].o-field-url > a').attr('href'), 'http://www.url1.com');
        assert.strictEqual(form.$('div[name="url2"].o-field-url > a').attr('href'), 'www.url2.com');
        assert.strictEqual(form.$('div[name="url3"].o-field-url > a').attr('href'), 'http://www.url3.com');
        assert.strictEqual(form.$('div[name="url4"].o-field-url > a').attr('href'), 'https://url4.com');
    ...
    QUnit.test('char field in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').length, 5,
            "should have 5 cells");
        assert.containsN(list, 'div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a', 5,
            "should have 5 anchors with correct classes");
        assert.hasAttrValue(list.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a').first(), 'href', 'http://yop',
            "should have proper href link");
        assert.strictEqual(list.$('tbody td:not(.o-list-record-selector)').first().text(), 'yop',
            "value should be displayed properly as text");
        ...
        assert.hasAttrValue(list.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a').first(), 'href', 'http://brolo',
            "should have proper new href link");
        assert.strictEqual(list.$('div.o-form-uri.o-field-widget.o-text-overflow.o-field-url > a').first().text(), 'brolo',
            "value should be properly updated");
    ...
    QUnit.test('url widget with falsy value', async function (assert) {
        ...
        assert.containsOnce(form, 'div.o-field-widget[name=foo]');
        assert.strictEqual(form.$('.o-field-widget[name=foo]').text(), "");
    ...
    QUnit.test('url old content is cleaned on render edit', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=foo]').text(), 'yop',
            "the starting value should be displayed properly");
        await testUtils.form.clickEdit(form);

        assert.strictEqual(form.$('.o-field-widget[name=foo2]').val(), 'foo2',
            "input should contain field value in edit mode");
        
        await testUtils.fields.editInput(form.$('.o-field-widget[name=foo2]'), 'bonjour');
        assert.strictEqual(form.$('.o-field-widget[name=foo]').text(), 'bonjour',
        "Url widget should show the new value and not " + form.$('.o-field-widget[name=foo]').text());
    ...
    QUnit.test('Char & Text Fields: Copy to clipboard button', async function (assert) {
        ...
        assert.containsOnce(form, '.o-clipboard-button.o-btn-text-copy',"Should have copy button on text type field");
        assert.containsOnce(form, '.o-clipboard-button.o-btn-char-copy',"Should have copy button on char type field");
    ...
    QUnit.test('CopyClipboard widget on unset field', async function (assert) {
        ...
        assert.containsNone(form, '.o-field-copy[name="foo"] .o-clipboard-button',
    ...
    QUnit.test('CopyClipboard widget on readonly unset fields in create mode', async function (assert) {
        ...
        this.data.partner.fields.displayName.readonly = true;
        ...
        var form = await createView({
            ...
            arch: '<form>' +
                    '<sheet>' +
                        '<group>' +
                            '<field name="displayName" widget="CopyClipboardChar" />' +
                        '</group>' +
                    '</sheet>' +
                '</form>',
        });

        assert.containsNone(form, '.o-field-copy[name="displayName"] .o-clipboard-button',
    ...
    QUnit.test('text fields are correctly rendered', async function (assert) {
        ...
        assert.ok(form.$('.o-field-text').length, "should have a text area");
        assert.strictEqual(form.$('.o-field-text').text(), 'yop', 'should be "yop" in readonly');

        await testUtils.form.clickEdit(form);

        var $textarea = form.$('textarea.o-field-text');
        ...
        assert.strictEqual(form.$('.o-field-text').text(), 'hello world',
    ...
    QUnit.test('text field translatable', async function (assert) {
        ...
        await testUtils.form.clickEdit(form);
        var $button = form.$('textarea + .o-field-translate');
        assert.strictEqual($button.length, 1, "should have a translate button");
        await testUtils.dom.click($button);
    ...
    QUnit.test('go to next line (and not the next row) when pressing enter', async function (assert) {
        ...
        await testUtils.dom.click(list.$('tbody tr:first .o-list-text'));
        var $textarea = list.$('textarea.o-field-text');
    ...
    QUnit.test('binary fields are correctly rendered', async function (assert) {
        ...
        var oldGetFile = session.getFile;
        session.getFile = function (option) {
        ...
        assert.containsOnce(form, 'a.o-field-widget[name="document"] > .fa-download',
            "the binary field should be rendered as a downloadable link in readonly");
        assert.strictEqual(form.$('a.o-field-widget[name="document"]').text().trim(), 'coucou.txt',
            "the binary field should display the name of the file in the link");
        assert.strictEqual(form.$('.o-field-char').text(), 'coucou.txt',
            "the filename field should have the file name as value");

        await testUtils.dom.click(form.$('a.o-field-widget[name="document"]'));

        await testUtils.form.clickEdit(form);

        assert.containsNone(form, 'a.o-field-widget[name="document"] > .fa-download',
            "the binary field should not be rendered as a downloadable link in edit");
        assert.strictEqual(form.$('div.o-field-binary-file[name="document"] > input').val(), 'coucou.txt',
            "the binary field should display the file name in the input edit mode");
        assert.hasAttrValue(form.$('.o-field-binary-file > input'), 'readonly', 'readonly',
            "the input should be readonly");
        assert.containsOnce(form, '.o-field-binary-file > .o-clear-file-button',
            "there shoud be a button to clear the file");
        assert.strictEqual(form.$('input.o-field-char').val(), 'coucou.txt',
            "the filename field should have the file name as value");


        await testUtils.dom.click(form.$('.o-field-binary-file > .o-clear-file-button'));

        assert.isNotVisible(form.$('.o-field-binary-file > input'),
            "the input should be hidden");
        assert.strictEqual(form.$('.o-field-binary-file > .o-select-file-button:not(.o-hidden)').length, 1,
        ...
        assert.strictEqual(form.$('a.o-field-widget[name="document"]').text().trim(), '',
            "the binary field should not display a filename in the link since we removed the file");
        assert.strictEqual(form.$('.o-field-char').text().trim(), '',
            "the filename field should be empty since we removed the file");

        form.destroy();

        // restore the session function
        session.getFile = oldGetFile;
    });

    QUnit.test('binary fields: option acceptedFileExtensions', async function (assert) {
        assert.expect(1);
        ...
        var form = await createView({
            ...
            data: this.data,
            arch: `<form string="Partners">
                      <field name="document" widget="binary" options="{'acceptedFileExtensions': '.dat,.bin'}"/>
                   </form>`
        });
        assert.strictEqual(form.$('input.o-input-file').attr('accept'), '.dat,.bin',
    ...
    QUnit.test('binary fields that are readonly in create mode do not download', async function (assert) {
        ...
        assert.containsOnce(form, 'a.o-field-widget[name="document"]',
            'The link to download the binary should be present');
        assert.containsNone(form, 'a.o-field-widget[name="document"] > .fa-download',
            'The download icon should not be present');

        var link = form.$('a.o-field-widget[name="document"]');
    ...
    QUnit.test("pdf_viewer without data", async function (assert) {
        ...
        assert.hasClass(form.$('.o-field-widget'), 'o-field-pdfviewer');
        assert.strictEqual(form.$('.o-select-file-button:not(.o-hidden)').length, 1,
            "there should be a visible 'Upload' button");
        assert.isNotVisible(form.$('.o-field-widget iframe.o-pdfview-iframe'),
    ...
    QUnit.test("pdf_viewer: basic rendering", async function (assert) {
        ...
        assert.hasClass(form.$('.o-field-widget'), 'o-field-pdfviewer');
        assert.strictEqual(form.$('.o-select-file-button:not(.o-hidden)').length, 0,
            "there should not be a any visible 'Upload' button");
        assert.isVisible(form.$('.o-field-widget iframe.o-pdfview-iframe'),
            "there should be an visible iframe");
        assert.hasAttrValue(form.$('.o-field-widget iframe.o-pdfview-iframe'), 'data-src',
    ...
    QUnit.test("pdf_viewer: upload rendering", async function (assert) {
        ...
        testUtils.mock.patch(fieldRegistry.map.pdf_viewer, {
        ...
        testUtils.mock.unpatch(fieldRegistry.map.pdf_viewer);
        form.destroy();
    });
    ...
    QUnit.test('text field rendering in list view', async function (assert) {
        ...
        assert.strictEqual(list.$('tbody td.o-list-text:contains(some text)').length, 1,
            "should have a td with the .o-list-text class");
        list.destroy();
    });
    ...
    QUnit.test("binary fields input value is empty whean clearing after uploading", async function (assert) {
        ...
        form.$('.o-input-file').attr('type', 'text').val('coucou.txt');

        assert.strictEqual(form.$('.o-input-file').val(), 'coucou.txt',
            "input value should be changed to \"coucou.txt\"");

        await testUtils.dom.click(form.$('.o-field-binary-file > .o-clear-file-button'));

        assert.strictEqual(form.$('.o-input-file').val(), '',
    ...
    QUnit.test('image fields are correctly rendered', async function (assert) {
        ...
        var form = await createView({
            ...
            resId: 1,
            async mockRPC(route, args) {
                if (route === '/web/dataset/callKw/partner/read') {
                    assert.deepEqual(args.args[1], ['document', '__last_update', 'displayName'], "The fields document, displayName and __last_update should be present when reading an image");
                }
        ...
        assert.hasClass(form.$('div[name="document"]'),'o-field-image',
    ...
    QUnit.test('image: option acceptedFileExtensions', async function (assert) {
        assert.expect(2);
        ...
        var form = await createView({
            ...
            data: this.data,
            arch: `<form string="Partners">
                      <field name="document" widget="image" options="{'acceptedFileExtensions': '.png,.jpeg'}"/>
                   </form>`
        });
        assert.strictEqual(form.$('input.o-input-file').attr('accept'), '.png,.jpeg',
            "the input should have the correct ``accept`` attribute");
        form.destroy();
    ...
    QUnit.test('image fields in subviews are loaded correctly', async function (assert) {
        ...
        assert.containsOnce(form, '.o-kanban-record.oe-kanban-global-click',
    ...
    QUnit.test('image fields with required attribute', async function (assert) {
        ...
        assert.hasClass(form.$('.o-form-view'),'o-form-editable',
            "form view should still be editable");
        assert.hasClass(form.$('.o-field-widget'),'o-field-invalid',
    ...
    /**
     * Same tests than for Image fields, but for Char fields with imageUrl widget.
     */
    QUnit.module('FieldChar-ImageUrlWidget', {
        beforeEach: function () {
            // specific sixth partner data for imageUrl widget tests
    ...
    QUnit.test('image fields are correctly rendered', async function (assert) {
        ...
        const form = await createView({
            ...
            data: this.data,
            arch: '<form string="Partners">' +
                    '<field name="foo" widget="imageUrl" options="{\'size\': [90, 90]}"/> ' +
                '</form>',
            resId: 6,
            async mockRPC(route, args) {
        ...
        assert.hasClass(form.$('div[name="foo"]'), 'o-field-image',
            "the widget should have the correct class");
    ...
    QUnit.test('image fields are correctly rendered with one dimension set', async function (assert) {
        ...
        const form = await createView({
            ...
            data: this.data,
            arch: '<form string="Partners">' +
                '<field name="foo" widget="imageUrl" options="{\'size\': [180, 0]}"/> ' +
                '<field name="tortue" widget="imageUrl" options="{\'size\': [0, 270]}"/> ' +
                '</form>',
            resId: 6,
        });
    ...
    QUnit.test('imageUrl widget in subviews are loaded correctly', async function (assert) {
        assert.expect(6);
        ...
        const form = await createView({
            ...
            arch: '<form string="Partners">' +
                    ...
                    '<field name="timmy" widget="many2many" mode="kanban">' +
                        ...
                        '</kanban>' +
                        '<form>' +
                            '<field name="image" widget="imageUrl"/>' +
                        '</form>' +
                    '</field>' +
                '</form>',
            resId: 6,
        ...
        createView({
            ...
            arch: '<kanban class="o-kanban-test">' +
                    ...
                    '<templates><t t-name="kanban-box">' +
                        '<div>' +
                        '<field name="graph_data" t-att-graph_type="record.graph_type.rawValue" widget="dashboard_graph"/>' +
                        '</div>' +
                    '</t>' +
                '</templates></kanban>',
            domain: [['id', 'in', [1, 2]]],
    ...
    QUnit.test('graph dashboard widget is rendered correctly', async function (assert) {
        ...
        createView({
            ...
            concurrency.delay(0).then(function () {
                assert.strictEqual(kanban.$('.o-kanban-record:first() .o-graph-barchart').length, 1,
                    "graph of first record should be a barchart");
                assert.strictEqual(kanban.$('.o-kanban-record:nth(1) .o-dashboard-graph').length, 1,
                ...
                assert.strictEqual(kanban.$('.o-kanban-record:first() canvas').length, 1,
    ...
    QUnit.test('rendering of a field with dashboard_graph widget in an updated kanban view (ungrouped)', async function (assert) {
        ...
        createView({
            ...
            concurrency.delay(0).then(function () {
                assert.containsN(kanban, '.o-dashboard-graph canvas', 2, "there should be two graph rendered");
                return kanban.update({});
            }).then(function () {
                return concurrency.delay(0); // one graph is re-rendered
            }).then(function () {
                assert.containsN(kanban, '.o-dashboard-graph canvas', 2, "there should be one graph rendered");
                kanban.destroy();
                done();
            });
        });
    ...
    QUnit.test('rendering of a field with dashboard_graph widget in an updated kanban view (grouped)', async function (assert) {
        ...
        createView({
            ...
            concurrency.delay(0).then(function () {
                ...
                assert.containsOnce(kanban, '.o-dashboard-graph canvas', "there should be one graph rendered");
                kanban.destroy();
                done();
            });
        });
    ...
    QUnit.test('handle widget in x2m', async function (assert) {
        ...
        assert.strictEqual(form.$('td span.o-row-handle').text(), "",
            "handle should not have any content");

        assert.notOk(form.$('td span.o-row-handle').is(':visible'),
            "handle should be invisible in readonly mode");

        assert.containsN(form, 'span.o-row-handle', 2, "should have 2 handles");

        await testUtils.form.clickEdit(form);

        assert.hasClass(form.$('td:first'),'o-handle-cell',
            "column widget should be displayed in css class");

        assert.ok(form.$('td span.o-row-handle').is(':visible'),
            "handle should be visible in readonly mode");

        testUtils.dom.click(form.$('td').eq(1));
        assert.containsOnce(form, 'td:first span.o-row-handle',
    ...
    QUnit.test('handle widget with falsy values', async function (assert) {
        ...
        assert.containsN(list, '.o-row-handle:visible', this.data.partner.records.length,
    ...
    QUnit.test('Datetime field without quickedit [REQUIRE FOCUS]', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-date-range:first').text(), '02/08/2017 15:30:00',
            "the start date should be correctly displayed in readonly");
        assert.strictEqual(form.$('.o-field-date-range:last').text(), '03/13/2017 05:30:00',
        ...
        // open the first one
        await testUtils.dom.click(form.$('.o-field-date-range:first'));
        ...
        await testUtils.dom.click(form.$('.o-field-date-range:last'));
    ...
    QUnit.test('Date field without quickedit [REQUIRE FOCUS]', async function (assert) {
        ...
        this.data.partner.records[0].dateEnd = '2017-02-08';
        ...
        // Check date display correctly in readonly
        assert.strictEqual(form.$('.o-field-date-range:first').text(), '02/03/2017',
            "the start date should be correctly displayed in readonly");
        assert.strictEqual(form.$('.o-field-date-range:last').text(), '02/08/2017',
            "the end date should be correctly displayed in readonly");
        ...
        assert.strictEqual($('.daterangepicker:first').css('display'), 'none',
            "date range picker should be closed");
        assert.strictEqual(form.$('.o-field-date-range:first').val(), '02/16/2017',
            "the date should be '02/16/2017'");
        assert.strictEqual(form.$('.o-field-date-range:last').val(), '03/12/2017',
        ...
        assert.strictEqual($('.daterangepicker:last').css('display'), 'none',
            "date range picker should be closed");
        assert.strictEqual(form.$('.o-field-date-range:first').val(), '02/13/2017',
            "the start date should be '02/13/2017'");
        assert.strictEqual(form.$('.o-field-date-range:last').val(), '03/18/2017',
        ...
        assert.strictEqual(form.$('.o-field-date-range:first').text(), '02/13/2017',
            "the start date should be '02/13/2017' after save");
        assert.strictEqual(form.$('.o-field-date-range:last').text(), '03/18/2017',
    ...
    QUnit.test('Datetime field manually input value should send utc value to server', async function (assert) {
        ...
        await testUtils.fields.editInput(form.$('.o-field-date-range:first'), '02/08/2017 11:30:00');
        // save form
        await testUtils.form.clickSave(form);

        assert.strictEqual(form.$('.o-field-date-range:first').text(), '02/08/2017 11:30:00',
    ...
    QUnit.test('Daterange field manually input wrong value should show toaster', async function (assert) {
        ...
        await testUtils.fields.editInput(form.$('.o-field-date-range:first'), 'blabla');
        // click outside daterange field
        await testUtils.dom.click(form.$el);
        assert.hasClass(form.$('input[name=date]'), 'o-field-invalid',
            "date field should be displayed as invalid");
        // update input date with right value
        await testUtils.fields.editInput(form.$('.o-field-date-range:first'), '02/08/2017');
        assert.doesNotHaveClass(form.$('input[name=date]'), 'o-field-invalid',
    ...
    QUnit.test('date field: toggle datepicker [REQUIRE FOCUS]', async function (assert) {
        ...
        await testUtils.dom.openDatepicker(form.$('.o-datepicker'));

        assert.strictEqual($('.bootstrap-datetimepicker-widget:visible').length, 1,
            "datepicker should be opened");

        // focus another field
        await testUtils.dom.click(form.$('.o-field-widget[name=foo]').focus().mouseenter());
    ...
    QUnit.test('date field: toggle datepicker far in the future', async function (assert) {
        ...
        testUtils.dom.openDatepicker(form.$('.o-datepicker'));

        assert.strictEqual($('.bootstrap-datetimepicker-widget:visible').length, 1,
            "datepicker should be opened");

        // focus another field
        form.$('.o-field-widget[name=foo]').click().focus();
    ...
    QUnit.test('date field is empty if no date is set', async function (assert) {
        ...
        var $span = form.$('span.o-field-widget');
    ...
    QUnit.test('date field: set an invalid date when the field is already set', async function (assert) {
        ...
        var $input = form.$('.o-field-widget[name=date] input');
    ...
    QUnit.test('date field value should not set on first click', async function (assert) {
        ...
        testUtils.dom.openDatepicker(form.$('.o-datepicker'));
        assert.strictEqual(form.$('.o-datepicker-input').val(), '', "date field's input should be empty on first click");
    ...
    QUnit.test('date field in form view (with positive time zone offset)', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-date').text(), '02/03/2017',
            'the date should be correctly displayed in readonly');

        // switch to edit mode
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-datepicker-input').val(), '02/03/2017',
        ...
        assert.strictEqual(form.$('.o-datepicker-input').val(), '02/22/2017',
            'the selected date should be displayed in the input');

        // save
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-date').text(), '02/22/2017',
    ...
    QUnit.test('date field with warn_future option', async function (assert) {
        ...
        var $warn = form.$('.o-datepicker-warning:visible');
        assert.strictEqual($warn.length, 1, "should have a warning in the form view");

        await testUtils.fields.editSelect(form.$('.o-field-widget[name=date] input'), '');  // remove the value

        $warn = form.$('.o-datepicker-warning:visible');
    ...
    QUnit.test('date field in editable list view', async function (assert) {
        ...
        assert.containsOnce(list, 'input.o-datepicker-input',
            "the view should have a date input for editable mode");

        assert.strictEqual(list.$('input.o-datepicker-input').get(0), document.activeElement,
            "date input should have the focus");

        assert.strictEqual(list.$('input.o-datepicker-input').val(), '02/03/2017',
            'the date should be correct in edit mode');
        ...
        assert.ok(!$('.bootstrap-datetimepicker-widget').length, 'datepicker should be closed');
        assert.strictEqual(list.$('.o-datepicker-input').val(), '02/22/2017',
            'the selected date should be displayed in the input');

        // save
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.strictEqual(list.$('tr.o-data-row td:not(.o-list-record-selector)').text(), '02/22/2017',
            'the selected date should be displayed after saving');
    ...
    QUnit.test('date field remove value', async function (assert) {
        ...
        await testUtils.fields.editAndTrigger(form.$('.o-datepicker-input'), '', ['input', 'change', 'focusout']);
        assert.strictEqual(form.$('.o-datepicker-input').val(), '',
            'should have correctly removed the value');

        // save
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-date').text(), '',
            'the selected date should be displayed after saving');

        form.destroy();
    });

    QUnit.test('do not trigger a fieldChanged for datetime field with date widget', async function (assert) {
        assert.expect(3);
        ...
        assert.strictEqual(form.$('.o-datepicker-input').val(), '02/08/2017',
    ...
    QUnit.test('date field support internalization', async function (assert) {
        ...
        _.extend(core._t.database.parameters, {dateFormat: '%d. %b %Y', timeFormat: '%H:%M:%S'});
        ...
        var dateViewForm = form.$('.o-field-date').text();
        await testUtils.dom.click(form.$buttons.find('.o-form-button_edit'));
        await testUtils.dom.openDatepicker(form.$('.o-datepicker'));
        assert.strictEqual(form.$('.o-datepicker-input').val(), dateViewForm,
            "input date field should be the same as it was in the view form");

        await testUtils.dom.click($('.day:contains(30)'));
        var dateEditForm = form.$('.o-datepicker-input').val();
        await testUtils.dom.click(form.$buttons.find('.o-form-button-save'));
        assert.strictEqual(form.$('.o-field-date').text(), dateEditForm,
    ...
    QUnit.test('datetime field in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-date').text(), expectedDateString,
            'the datetime should be correctly displayed in readonly');

        // switch to edit mode
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-datepicker-input').val(), expectedDateString,
        ...
        assert.strictEqual(form.$('.o-datepicker-input').val(), newExpectedDateString,
            'the selected date should be displayed in the input');

        // save
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-date').text(), newExpectedDateString,
            'the selected date should be displayed after saving');
    ...
    QUnit.test('datetime fields do not trigger fieldChange before datetime completly picked', async function (assert) {
        ...
        assert.containsNone($('body'), '.bootstrap-datetimepicker-widget');
        assert.strictEqual(form.$('.o-datepicker-input').val(), "04/22/2017 08:25:35");
    ...
    QUnit.test('datetime field not visible in form view should not capture the focus on keyboard navigation', async function (assert) {
        ...
        assert.strictEqual(document.activeElement, form.$buttons.find('.o-form-button-save')[0],
    ...
    QUnit.test('datetime field with datetime formatted without second', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-date input').val(), expectedDateString,
            'the datetime should be correctly displayed in readonly');
    ...
    QUnit.test('datetime field in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('input.o-datepicker-input').val(), expectedDateString,
            'the date should be correct in edit mode');

        assert.containsNone($('body'), '.bootstrap-datetimepicker-widget');
        testUtils.dom.openDatepicker(list.$('.o-datepicker'));
        assert.containsOnce($('body'), '.bootstrap-datetimepicker-widget');
        ...
        var newExpectedDateString = "04/22/2017 08:25:35";
        assert.strictEqual(list.$('.o-datepicker-input').val(), newExpectedDateString,
            'the selected datetime should be displayed in the input');

        // save
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.strictEqual(list.$('tr.o-data-row td:not(.o-list-record-selector)').text(), newExpectedDateString,
    ...
    QUnit.test('multi edition of datetime field in list view: edit date in input', async function (assert) {
        ...
        assert.containsOnce(list, 'input.o-datepicker-input');
        list.$('.o-datepicker-input').val("10/02/2019 09:00:00");
        await testUtils.dom.triggerEvents(list.$('.o-datepicker-input'), ['change']);

        assert.containsOnce(document.body, '.modal');
        await testUtils.dom.click($('.modal .modal-footer .btn-primary'));

        assert.strictEqual(list.$('.o-data-row:first .o-data-cell').text(), "10/02/2019 09:00:00");
        assert.strictEqual(list.$('.o-data-row:nth(1) .o-data-cell').text(), "10/02/2019 09:00:00");
    ...
    QUnit.test('datetime field remove value', async function (assert) {
        ...
        // switch to edit mode
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-datepicker-input').val(), '02/08/2017 12:00:00',
            'the date time should be correct in edit mode');

        await testUtils.fields.editAndTrigger($('.o-datepicker-input'), '', ['input', 'change', 'focusout']);
        assert.strictEqual(form.$('.o-datepicker-input').val(), '',
    ...
    QUnit.test('datetime field with date/datetime widget (with day change)', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=p] .o-data-cell').text(), expectedDateString,
            'the datetime (datetime widget) should be correctly displayed in tree view');

        // switch to form view
        await testUtils.dom.click(form.$('.o-field-widget[name=p] .o-data-row'));
        assert.strictEqual($('.modal .o-field-date[name=datetime]').text(), '02/07/2017',
    ...
    QUnit.test('datetime field with date/datetime widget (without day change)', async function (assert) {
        ...
        // switch to form view
        await testUtils.dom.click(form.$('.o-field-widget[name=p] .o-data-row'));
        assert.strictEqual($('.modal .o-field-date[name=datetime]').text(), '02/08/2017',
            'the datetime (date widget) should be correctly displayed in form view');
    ...
    QUnit.test('remaining_days widget on a date field in list view', async function (assert) {
        ...
        assert.strictEqual(list.$('.o-data-cell:nth(0)').text(), 'Today');
        assert.strictEqual(list.$('.o-data-cell:nth(1)').text(), 'Tomorrow');
        assert.strictEqual(list.$('.o-data-cell:nth(2)').text(), 'Yesterday');
        assert.strictEqual(list.$('.o-data-cell:nth(3)').text(), 'In 2 days');
        assert.strictEqual(list.$('.o-data-cell:nth(4)').text(), '3 days ago');
        assert.strictEqual(list.$('.o-data-cell:nth(5)').text(), '02/08/2018');
        assert.strictEqual(list.$('.o-data-cell:nth(6)').text(), '06/08/2017');
        assert.strictEqual(list.$('.o-data-cell:nth(7)').text(), '');

        assert.strictEqual(list.$('.o-data-cell:nth(0) .o-field-widget').attr('title'), '10/08/2017');

        assert.hasClass(list.$('.o-data-cell:nth(0) div'), 'font-weight-bold text-warning');
        assert.doesNotHaveClass(list.$('.o-data-cell:nth(1) div'), 'font-weight-bold text-warning text-danger');
        assert.hasClass(list.$('.o-data-cell:nth(2) div'), 'font-weight-bold text-danger');
        assert.doesNotHaveClass(list.$('.o-data-cell:nth(3) div'), 'font-weight-bold text-warning text-danger');
        assert.hasClass(list.$('.o-data-cell:nth(4) div'), 'font-weight-bold text-danger');
        assert.doesNotHaveClass(list.$('.o-data-cell:nth(5) div'), 'font-weight-bold text-warning text-danger');
        assert.hasClass(list.$('.o-data-cell:nth(6) div'), 'font-weight-bold text-danger');
    ...
    QUnit.test('remaining_days widget on a date field in multi edit list view', async function (assert) {
        ...
        const list = await createView({
            ...
            model: 'partner',
            data: this.data,
            arch: '<tree multiEdit="1"><field name="date" widget="remaining_days"/></tree>',
            translateParameters: { // Avoid issues due to localization formats
                dateFormat: '%m/%d/%Y',
            },
        });
        ...
        await testUtils.dom.click(list.$('.o-data-row:first .o-data-cell'));
        assert.containsOnce(list, 'input.o-datepicker-input', 'should have date picker input');
        await testUtils.fields.editAndTrigger(list.$('.o-datepicker-input'), '10/10/2017', ['input', 'change', 'focusout']);

        assert.containsOnce(document.body, '.modal');
        assert.strictEqual($('.modal .o-field-widget').text(), "In 2 days",
            "should have 'In 2 days' value to change");
        await testUtils.dom.click($('.modal .modal-footer .btn-primary'));

        assert.strictEqual(list.$('.o-data-row:first .o-data-cell').text(), "In 2 days",
            "should have 'In 2 days' as date field value");
        assert.strictEqual(list.$('.o-data-row:nth(1) .o-data-cell').text(), "In 2 days",
            "should have 'In 2 days' as date field value");
    ...
    QUnit.test('remaining_days widget, enter wrong value manually in multi edit list view', async function (assert) {
        ...
        await testUtils.dom.click(list.$('.o-data-row:first .o-data-cell'));
        assert.containsOnce(list, 'input.o-datepicker-input', 'should have date picker input');
        await testUtils.fields.editAndTrigger(list.$('.o-datepicker-input'), 'blabla', ['input', 'change']);
    ...
    QUnit.test('remaining_days widget on a date field in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), 'Today');
        assert.hasClass(form.$('.o-field-widget'), 'font-weight-bold text-warning');

        // in edit mode, this widget should be editable.
        await testUtils.form.clickEdit(form);

        assert.hasClass(form.$('.o-form-view'), 'o-form-editable');
        assert.containsOnce(form, 'div.o-field-widget[name=date] .o-datepicker');
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), 'Tomorrow');

        await testUtils.form.clickEdit(form);
        await testUtils.dom.openDatepicker(form.$('.o-datepicker'));
        await testUtils.dom.click($('.bootstrap-datetimepicker-widget .day[data-day="10/07/2017"]'));
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), 'Yesterday');
        assert.hasClass(form.$('.o-field-widget'), 'text-danger');
    ...
    QUnit.test('remaining_days widget on a datetime field in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), 'Today');
        assert.hasClass(form.$('.o-field-widget'), 'text-warning');

        // in edit mode, this widget should be editable.
        await testUtils.form.clickEdit(form);

        assert.hasClass(form.$('.o-form-view'), 'o-form-editable');
        assert.containsOnce(form, 'div.o-field-widget[name=datetime] .o-datepicker');
    ...
    QUnit.test('remaining_days widget on a datetime field in list view in UTC+6', async function (assert) {
        ...
        assert.strictEqual(list.$('.o-data-cell:nth(0)').text(), 'Tomorrow');
        assert.strictEqual(list.$('.o-data-cell:nth(1)').text(), 'Tomorrow');
        assert.strictEqual(list.$('.o-data-cell:nth(2)').text(), 'Today');
        assert.strictEqual(list.$('.o-data-cell:nth(3)').text(), 'Yesterday');
        assert.strictEqual(list.$('.o-data-cell:nth(4)').text(), 'In 2 days');

        assert.strictEqual(list.$('.o-data-cell:nth(0) .o-field-widget').attr('title'), '10/09/2017');
    ...
    QUnit.test('remaining_days widget on a datetime field in list view in UTC-8', async function (assert) {
        ...
        assert.strictEqual(list.$('.o-data-cell:nth(0)').text(), 'Today');
        assert.strictEqual(list.$('.o-data-cell:nth(1)').text(), 'Today');
        assert.strictEqual(list.$('.o-data-cell:nth(2)').text(), 'Tomorrow');
        assert.strictEqual(list.$('.o-data-cell:nth(3)').text(), 'Yesterday');
        assert.strictEqual(list.$('.o-data-cell:nth(4)').text(), '2 days ago');
    ...
    QUnit.test('monetary field in form view', async function (assert) {
        ...
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '$\u00a09.10',
            'The value should be displayed properly.');

        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '9.10',
            'The input should be rendered without the currency symbol.');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').parent().children().first().text(), '$',
            'The input should be preceded by a span containing the currency symbol.');

        await testUtils.fields.editInput(form.$('.o-field-monetary input'), '108.2458938598598');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '108.2458938598598',
            'The value should not be formated yet.');

        await testUtils.form.clickSave(form);
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '$\u00a0108.25',
            'The new value should be rounded properly.');
    ...
    QUnit.test('monetary field in the lines of a form view', async function (assert) {
        ...
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-list-table .o-list-number').first().text(), '$\u00a099.9',
                           'The value should be displayed properly.');
        assert.hasAttrValue(form.$('.o-list-table .o-list-number').first(), 'title', '$\u00a099.9',
    ...
    QUnit.test('monetary field rounding using formula in form view', async function (assert) {
        ...
        // Test computation and rounding
        await testUtils.form.clickEdit(form);
        await testUtils.fields.editInput(form.$('.o-field-monetary input'), '=100/3');
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '$\u00a033.33',
    ...
    QUnit.test('monetary field with currency symbol after', async function (assert) {
        ...
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '0.00\u00a0€',
            'The value should be displayed properly.');

        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '0.00',
            'The input should be rendered without the currency symbol.');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').parent().children().eq(1).text(), '€',
            'The input should be followed by a span containing the currency symbol.');

        await testUtils.fields.editInput(form.$('.o-field-widget[name=qux] input'), '108.2458938598598');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '108.2458938598598',
            'The value should not be formated yet.');
    ...
    QUnit.test('monetary field with currency digits != 2', async function (assert) {
        ...
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '99.1234\u00a0Bs.F',
            'The value should be displayed properly.');

        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '99.1234',
            'The input should be rendered without the currency symbol.');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').parent().children().eq(1).text(), 'Bs.F',
            'The input should be followed by a span containing the currency symbol.');

        await testUtils.fields.editInput(form.$('.o-field-widget[name=qux] input'), '99.111111111');
        assert.strictEqual(form.$('.o-field-widget[name=qux] input').val(), '99.111111111',
            'The value should not be formated yet.');

        await testUtils.form.clickSave(form);
        // Non-breaking space between the currency and the amount
        assert.strictEqual(form.$('.o-field-widget').first().text(), '99.1111\u00a0Bs.F',
            'The new value should be rounded properly.');
    ...
    QUnit.test('monetary field in editable list view', async function (assert) {
        ...
        // switch to edit mode
        var $cell = list.$('tr.o-data-row td:not(.o-list-record-selector):contains($)');
        await testUtils.dom.click($cell);
        ...
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.strictEqual(list.$('tr.o-data-row td:not(.o-list-record-selector):contains($)').text(), '$\u00a0108.25',
            'The new value should be rounded properly.');
    ...
    QUnit.test('monetary field with real monetary field in model', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-monetary').first().html(), "$&nbsp;9.10",
            "readonly value should contain the currency");
        assert.strictEqual(form.$('.o-field-monetary').first().next().html(), "$&nbsp;4.20",
            "readonly value should contain the currency");

        await testUtils.form.clickEdit(form);

        assert.strictEqual(form.$('.o-field-monetary > input').val(), "9.10",
        ...
        assert.containsOnce(form, '.o-field-monetary > input',
            "After the onchange, the monetary <input/> should not have been duplicated");
        assert.containsOnce(form, '.o-field-monetary[name=quux]',
            "After the onchange, the monetary readonly field should not have been duplicated");

        await testUtils.fields.many2one.clickOpenDropdown('currencyId');
        await testUtils.fields.many2one.clickItem('currencyId','€');
        assert.strictEqual(form.$('.o-field-monetary > span').html(), "€",
    ...
    QUnit.test('monetary field with monetary field given in options', async function (assert) {
        ...
        var form = await createView({
            ...
            arch:'<form string="Partners">' +
                    '<sheet>' +
                        '<field name="qux" options="{\'currencyField\': \'company_currency_id\'}"/>' +
        ...
        assert.strictEqual(form.$('.o-field-monetary').html(), "9.10&nbsp;€",
    ...
    QUnit.test('should keep the focus when being edited in x2many lists', async function (assert) {
        ...
        this.data.partner.fields.currencyId.default = 1;
        ...
        var $o2m = form.$('.o-field-widget[name=p]');
        await testUtils.dom.click($o2m.find('.o-field-x2many-list-row-add a'));
        await testUtils.fields.editInput($o2m.find('.o-field-widget input'), "22");

        assert.strictEqual($o2m.find('.o-field-widget input').get(0), document.activeElement,
            "the focus should still be on the input");
        assert.strictEqual($o2m.find('.o-field-widget input').val(), "22",
            "the value should not have been formatted yet");

        await testUtils.dom.click(form.$el);

        assert.strictEqual($o2m.find('.o-field-widget[name=qux]').html(), "$&nbsp;22.00",
            "the value should have been formatted after losing the focus");

        // test the monetary field inside the many2many
        var $m2m = form.$('.o-field-widget[name=m2m]');
        await testUtils.dom.click($m2m.find('.o-data-row td:first'));
        await testUtils.fields.editInput($m2m.find('.o-field-widget input'), "22");

        assert.strictEqual($m2m.find('.o-field-widget input').get(0), document.activeElement,
            "the focus should still be on the input");
        assert.strictEqual($m2m.find('.o-field-widget input').val(), "22",
            "the value should not have been formatted yet");

        await testUtils.dom.click(form.$el);

        assert.strictEqual($m2m.find('.o-field-widget[name=qux]').html(), "22.00&nbsp;€",
            "the value should have been formatted after losing the focus");
    ...
    QUnit.test('monetary field with currency set by an onchange',async function (assert) {
        ...
        this.data.partner.onchanges = {
            int_field: function (obj) {
                obj.currencyId = obj.int_field ? 2 : null;
            },
        };
        ...
        await testUtils.dom.click(list.$buttons.find('.o-list-button-add'));
        assert.containsOnce(list, 'div.o-field-widget[name=qux] input',
            "monetary field should have been rendered correctly (without currency)");
        assert.containsNone(list, '.o-field-widget[name=qux] span',
            "monetary field should have been rendered correctly (without currency)");

        // set a value for int_field -> should set the currency and re-render qux
        await testUtils.fields.editInput(list.$('.o-field-widget[name=int_field]'),'7');
        assert.containsOnce(list, 'div.o-field-widget[name=qux] input',
            "monetary field should have been re-rendered correctly (with currency)");
        assert.strictEqual(list.$('.o-field-widget[name=qux] span:contains(€)').length, 1,
            "monetary field should have been re-rendered correctly (with currency)");
        var $quxInput = list.$('.o-field-widget[name=qux] input');
        ...
        await testUtils.dom.click(list.$('.o-field-widget[name=int_field]'));
        await testUtils.fields.editInput(list.$('.o-field-widget[name=int_field]'),'0');
        $quxInput = list.$('div.o-field-widget[name=qux] input');
    ...
    QUnit.test('integer field when unset', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), "0",
            'Non-set integer field should be recognized as 0.');
    ...
    QUnit.test('integer field in form view', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), '-18',
    ...
    QUnit.test('integer field rounding using formula in form view', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '33',
            'The new value should be calculated properly.');
    ...
    QUnit.test('integer field in form view with virtual id', async function (assert) {
        ...
        params.resId = this.data.partner.records[1].id = "2-20170808020000";
        var form = await createView(params);
        assert.strictEqual(form.$('.o-field-widget').text(), "2-20170808020000",
    ...
    QUnit.test('integer field in editable list view', async function (assert) {
        ...
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.strictEqual(list.$('td:not(.o-list-record-selector)').first().text(), '-28',
            'The new value should be saved and displayed properly.');
    ...
    QUnit.test('integer field with type number option', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget').val(), '1234567890',
            'Integer value must be not formatted if input type is number.');
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').text(), '1,234,567,890',
    ...
    QUnit.test('integer field without type number option', async function (assert) {
        ...
        await testUtils.form.clickSave(form);
        await testUtils.form.clickEdit(form);
        assert.strictEqual(form.$('.o-field-widget').val(), '1,234,567,890',
    ...
    QUnit.test('integer field without formatting', async function (assert) {
        ...
        assert.ok(form.$('.o-form-view').hasClass('o-form-readonly'), 'Form in readonly mode');
        assert.strictEqual(form.$('.o-field-widget[name=int_field]').text(), '8069',
            'Integer value must not be formatted');
        await testUtils.form.clickEdit(form);

        assert.strictEqual(form.$('.o-field-widget').val(), '8069',
            'Integer value must not be formatted');
    ...
    QUnit.test('integer field is formatted by default', async function (assert) {
        ...
        assert.ok(form.$('.o-form-view').hasClass('o-form-readonly'), 'Form in readonly mode');
        assert.strictEqual(form.$('.o-field-widget[name=int_field]').text(), '8,069',
            'Integer value must be formatted by default');
        await testUtils.form.clickEdit(form);

        assert.strictEqual(form.$('.o-field-widget').val(), '8,069',
            'Integer value must be formatted by default');
    ...
    QUnit.test('floatTime field in form view', async function (assert) {
        assert.expect(5);
        ...
        var form = await createView({
            ...
            arch:'<form string="Partners">' +
                    '<sheet>' +
                        '<field name="qux" widget="floatTime"/>' +
                    '</sheet>' +
                '</form>',
            mockRPC: function (route, args) {
                if (route === '/web/dataset/callKw/partner/write') {
        ...
        // 9 + 0.1 * 60 = 9.06
        assert.strictEqual(form.$('.o-field-widget').first().text(), '09:06',
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '-11:48',
            'The new value should be saved and displayed properly.');

        form.destroy();
    });

    QUnit.test('floatTime field value formatted on blur', async function (assert) {
        assert.expect(4);
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '09:30',
            'The new value should be saved and displayed properly.');

        form.destroy();
    });

    QUnit.test('floatTime field with invalid value', async function (assert) {
        assert.expect(5);
        ...
        assert.doesNotHaveClass(form.$('input[name=qux]'), 'o-field-invalid',
            "date field should not be displayed as invalid now");
    ...
    QUnit.test('floatFactor field in form view', async function (assert) {
        assert.expect(4);
        ...
        var form = await createView({
            ...
            arch:'<form string="Partners">' +
                    '<sheet>' +
                        '<field name="qux" widget="floatFactor" options="{\'factor\': 0.5}" digits="[16,2]"/>' +
                    '</sheet>' +
                '</form>',
            mockRPC: function (route, args) {
                if (route === '/web/dataset/callKw/partner/write') {
        ...
        assert.strictEqual(form.$('.o-field-widget').first().text(), '4.55', // 9.1 / 0.5
        ...
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('.o-field-widget').first().text(), '2.30',
            'The new value should be saved and displayed properly.');
    ...
    QUnit.test('float-toggle field in form view', async function (assert) {
        assert.expect(5);
        ...
        var form = await createView({
            ...
            arch:'<form string="Partners">' +
                    '<sheet>' +
                        '<field name="qux" widget="float-toggle" options="{\'factor\': 0.125, \'range\': [0, 1, 0.75, 0.5, 0.25]}" digits="[5,3]"/>' +
                    '</sheet>' +
                '</form>',
            mockRPC: function (route, args) {
                if (route === '/web/dataset/callKw/partner/write') {
        ...
        assert.strictEqual(form.$('.o-field-widget').first().text(), '0.056',
            'The formatted time value should be displayed properly.');

        await testUtils.form.clickEdit(form);

        assert.strictEqual(form.$('button.o-field-float-toggle').text(), '0.056',
            'The value should be rendered correctly on the button.');

        await testUtils.dom.click(form.$('button.o-field-float-toggle'));

        assert.strictEqual(form.$('button.o-field-float-toggle').text(), '1.000',
            'The value should be rendered correctly on the button.');

        await testUtils.form.clickSave(form);

        assert.strictEqual(form.$('.o-field-widget').first().text(), '1.000',
            'The new value should be saved and displayed properly.');

        form.destroy();
    });

    QUnit.test('float-toggle widget in kanban view(readonly) with option force_button', async function (assert) {
        assert.expect(2);
        ...
        var kanban = await createView({
            ...
            arch: '<kanban>' +
                    '<templates><t t-name="kanban-box">' +
                        '<div>' +
                        '<field name="qux" widget="float-toggle" options="{\'force_button\': true}"/>' +
                        '</div>' +
                    '</t>' +
                '</templates></kanban>',
            domain: [['id', 'in', [1]]],
        });
        assert.containsOnce(kanban, 'button.o-field-float-toggle', "should have rendered toggle button");
        const value = kanban.$('button.o-field-float-toggle').text();
        await testUtils.dom.click(kanban.$('button.o-field-float-toggle'));
        assert.notEqual(kanban.$('button.o-field-float-toggle').text(), value, "qux field value should be changed");
        kanban.destroy();
    });
    ...
    QUnit.test('phone field in form view on normal screens', async function (assert) {
        ...
        var $phone = form.$('div.o-field-widget.o-form-uri.o-field-phone > a');
        ...
        // save
        await testUtils.form.clickSave(form);
        assert.strictEqual(form.$('div.o-field-widget.o-form-uri.o-field-phone > a').text(), 'new',
            "new value should be displayed properly");
    ...
    QUnit.test('phone field in editable list view on normal screens', async function (assert) {
        ...
        assert.containsN(list, 'tbody td:not(.o-list-record-selector)', 5);
        ...
        assert.containsN(list, 'div.o-field-widget.o-form-uri.o-field-phone > a', 5,
    ...
    QUnit.test('use TAB to navigate to a phone field', async function (assert) {
        ...
        testUtils.dom.click(form.$('input[name=displayName]'));
    ...
    QUnit.test('priority widget when not set', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget.o-priority:not(.o-field-empty)').length, 1,
            "widget should be considered set, even though there is no value for this field");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star').length, 2,
            "should have two stars for representing each possible value: no star, one star and two stars");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star').length, 0,
            "should have no full star since there is no value");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star-o').length, 2,
    ...
    QUnit.test('priority widget in form view', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star').length, 2,
            "should have two stars for representing each possible value: no star, one star and two stars");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star').length, 1,
            "should have one full star since the value is the second value");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star-o').length, 1,
            "should have one empty star since the value is the second value");

        // hover last star
        form.$('.o-field-widget.o-priority a.o-priority-star.fa-star-o').last().trigger('mouseover');
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star').length, 2,
            "should have two stars for representing each possible value: no star, one star and two stars");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star').length, 2,
            "should temporary have two full stars since we are hovering the third value");
        assert.strictEqual(form.$('.o-field-widget.o-priority').find('a.o-priority-star.fa-star-o').length, 0,
        ...
        await testUtils.dom.click(form.$('.o-field-widget.o-priority a.o-priority-star.fa-star-o').last());
    ...
    QUnit.test('priority widget in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority:not(.o-field-empty)').length, 1,
            "widget should be considered set");
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star').length, 2,
            "should have two stars for representing each possible value: no star, one star and two stars");
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star.fa-star').length, 1,
            "should have one full star since the value is the second value");
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star.fa-star-o').length, 1,
            "should have one empty star since the value is the second value");
        ...
        // hover last star
        list.$('.o-data-row .o-priority a.o-priority-star.fa-star-o').first().trigger('mouseenter');
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star').length, 2,
            "should have two stars for representing each possible value: no star, one star and two stars");
        assert.strictEqual(list.$('.o-data-row').first().find('a.o-priority-star.fa-star').length, 2,
            "should temporary have two full stars since we are hovering the third value");
        assert.strictEqual(list.$('.o-data-row').first().find('a.o-priority-star.fa-star-o').length, 0,
            "should temporary have no empty star since we are hovering the third value");

        // click on the first star in readonly mode
        await testUtils.dom.click(list.$('.o-priority a.o-priority-star.fa-star').first());

        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star').length, 2,
            "should still have two stars");
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star.fa-star').length, 0,
            "should now have no full star since the value is the first value");
        assert.strictEqual(list.$('.o-data-row').first().find('.o-priority a.o-priority-star.fa-star-o').length, 2,
        ...
        await testUtils.dom.click(list.$('.o-priority a.o-priority-star.fa-star-o').last());

        assert.strictEqual(list.$('.o-data-row').last().find('.o-priority a.o-priority-star').length, 2,
            "should still have two stars");
        assert.strictEqual(list.$('.o-data-row').last().find('.o-priority a.o-priority-star.fa-star').length, 2,
            "should now have two full stars since the value is the third value");
        assert.strictEqual(list.$('.o-data-row').last().find('.o-priority a.o-priority-star.fa-star-o').length, 0,
            "should now have no empty star since the value is the third value");
    ...
    QUnit.test('priority widget with readonly attribute', async function (assert) {
        ...
        assert.strictEqual(form.$('span.o-priority-star.fa.fa-star-o').length, 2,
        "stars of priority widget should rendered with span tag if readonly");

        await testUtils.dom.click(form.$('.o-priority-star.fa-star-o').last());

        assert.strictEqual(form.$('.o-priority-star.fa.fa-star-o').length, 2,
        "should still have two stars");
    ...
    QUnit.test('priority widget edited by the smart action "Set priority..."', async function (assert) {
        ...
        await nextTick();
        const idx = [...webClient.el.querySelectorAll(".o-command")].map(el => el.textContent).indexOf("Set priority...ALT + R")
        assert.ok(idx >= 0);
    ...
    QUnit.test('state_selection widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-widget.o_selection > a span.o-status.o-status-red',
            "should have one red status since selection is the second, blocked state");
        assert.containsNone(form, '.o-field-widget.o_selection > a span.o-status.o-status-green',
        ...
        await testUtils.dom.click(form.$('.o-field-widget.o_selection .o-status').first());
        ...
        assert.containsNone(form, '.o-field-widget.o_selection > a span.o-status.o-status-red',
        ...
        assert.containsOnce(form, '.o-field-widget.o_selection > a span.o-status',
        ...
        assert.containsOnce(form, '.o-field-widget.o_selection > a span.o-status.o-status-green',
    ...
    QUnit.test('state_selection widget with readonly modifier', async function (assert) {
        ...
        assert.hasClass(form.$('.o_selection'), 'o-readonly-modifier');
    ...
    QUnit.test('state_selection widget for list view with hide_label option', async function (assert) {
        ...
        assert.containsN(list, '.o-state-selection-cell .o_selection > a span.o-status', 10,
            "should have ten status selection widgets");
        assert.containsN(list, '.o-state-selection-cell .o_selection[name=selection] > span.align-middle', 5,
            "should have five label on selection widgets");
        assert.containsOnce(list, '.o-state-selection-cell .o_selection[name=selection] > span.align-middle:contains(Done)',
            "should have one Done status label");
        assert.containsN(list, '.o-state-selection-cell .o_selection[name=selection] > span.align-middle:contains(Normal)', 3,
            "should have three Normal status label");
        assert.containsN(list, '.o-state-selection-cell .o_selection[name=graph_type] > a span.o-status', 5,
            "should have five status selection widgets");
        assert.containsNone(list, '.o-state-selection-cell .o_selection[name=graph_type] > span.align-middle',
    ...
    QUnit.test('state_selection widget in editable list view', async function (assert) {
        ...
        assert.containsN(list, '.o-state-selection-cell .o_selection > a span.o-status', 5,
            "should have five status selection widgets");
        assert.containsOnce(list, '.o-state-selection-cell .o_selection > a span.o-status.o-status-red',
            "should have one red status");
        assert.containsOnce(list, '.o-state-selection-cell .o_selection > a span.o-status.o-status-green',
            "should have one green status");
        assert.containsNone(list, '.dropdown-menu.state:visible',
            "there should not be a dropdown");

        // Click on the status button to make the dropdown appear
        var $cell = list.$('tbody td.o-state-selection-cell').first();
        await testUtils.dom.click(list.$('.o-state-selection-cell .o_selection > a span.o-status').first());
        assert.doesNotHaveClass($cell.parent(), 'o-selected-row',
        ...
        assert.containsNone(list, '.o-state-selection-cell .o_selection > a span.o-status.o-status-red',
            "should now have no red status");
        assert.containsOnce(list, '.o-state-selection-cell .o_selection > a span.o-status.o-status-green',
            "should still have one green status");
        assert.containsNone(list, '.dropdown-menu.state:visible',
            "there should not be a dropdown");
        assert.containsNone(list, 'tr.o-selected-row', 'should not be in edit mode');

        // switch to edit mode and check the result
        $cell = list.$('tbody td.o-state-selection-cell').first();
        await testUtils.dom.click($cell);
        ...
        var $lastCell = list.$('tbody td.o-state-selection-cell').last();
        await testUtils.dom.click($lastCell);
        assert.containsNone(list, '.dropdown-menu.state:visible',
            "there should not be a dropdown anymore");
        var $firstCell = list.$('tbody td.o-state-selection-cell').first();
        assert.doesNotHaveClass($firstCell.parent(), 'o-selected-row',
            'first row should not be in edit mode anymore');
        assert.hasClass($lastCell.parent(),'o-selected-row',
            'last row should be in edit mode');

        // Click on the last status button to make the dropdown appear
        await testUtils.dom.click(list.$('.o-state-selection-cell .o_selection > a span.o-status').last());
        assert.containsOnce(list, '.dropdown-menu.state:visible',
            "there should be a dropdown");
        assert.containsN(list, '.dropdown-menu.state:visible .dropdown-item', 2,
            "there should be two options in the dropdown");
        ...
        assert.containsN(list, '.o-state-selection-cell .o_selection > a span.o-status.o-status-green', 2,
    ...
    QUnit.test('state_selection edited by the smart action "Set kanban state..."', async function (assert) {
        ...
        assert.containsOnce(webClient, ".o-status-red")

        triggerHotkey("control+k")
        await nextTick();
        const idx = [...webClient.el.querySelectorAll(".o-command")].map(el => el.textContent).indexOf("Set kanban state...ALT + SHIFT + R")
        assert.ok(idx >= 0);
        ...
        await click(webClient.el, "#o-command-2")
        await legacyExtraNextTick();
        assert.containsOnce(webClient, ".o-status-green")
    });
    ...
    QUnit.test('favorite widget in kanban view', async function (assert) {
        ...
        assert.containsOnce(kanban, '.o-kanban-record .o-field-widget.o-favorite > a i.fa.fa-star',
            'should be favorite');
        assert.strictEqual(kanban.$('.o-kanban-record .o-field-widget.o-favorite > a').text(), ' Remove from Favorites',
            'the label should say "Remove from Favorites"');

        // click on favorite
        await testUtils.dom.click(kanban.$('.o-field-widget.o-favorite'));
        assert.containsNone(kanban, '.o-kanban-record  .o-field-widget.o-favorite > a i.fa.fa-star',
            'should not be favorite');
        assert.strictEqual(kanban.$('.o-kanban-record  .o-field-widget.o-favorite > a').text(), ' Add to Favorites',
    ...
    QUnit.test('favorite widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-widget.o-favorite > a i.fa.fa-star',
            'should be favorite');
        assert.strictEqual(form.$('.o-field-widget.o-favorite > a').text(), ' Remove from Favorites',
            'the label should say "Remove from Favorites"');

        // click on favorite
        await testUtils.dom.click(form.$('.o-field-widget.o-favorite'));
        assert.containsNone(form, '.o-field-widget.o-favorite > a i.fa.fa-star',
            'should not be favorite');
        assert.strictEqual(form.$('.o-field-widget.o-favorite > a').text(), ' Add to Favorites',
            'the label should say "Add to Favorites"');

        // switch to edit mode
        await testUtils.form.clickEdit(form);
        assert.containsOnce(form, '.o-field-widget.o-favorite > a i.fa.fa-star-o',
            'should not be favorite');
        assert.strictEqual(form.$('.o-field-widget.o-favorite > a').text(), ' Add to Favorites',
            'the label should say "Add to Favorites"');
    ...
    QUnit.test('favorite widget in editable list view without label', async function (assert) {
        ...
        assert.containsOnce(list, '.o-data-row:first .o-field-widget.o-favorite > a i.fa.fa-star',
            'should be favorite');
        ...
        // click on favorite
        await testUtils.dom.click(list.$('.o-data-row:first .o-field-widget.o-favorite'));
        assert.containsNone(list, '.o-data-row:first .o-field-widget.o-favorite > a i.fa.fa-star',
            'should not be favorite');

        // save
        await testUtils.dom.click(list.$buttons.find('.o-list-button-save'));
        assert.containsOnce(list, '.o-data-row:first .o-field-widget.o-favorite > a i.fa.fa-star-o',
            'should not be favorite');
    ...
    QUnit.test('label_selection widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-widget.badge.badge-warning',
            "should have a warning status label since selection is the second, blocked state");
        assert.containsNone(form, '.o-field-widget.badge.badge-secondary',
            "should not have a default status since selection is the second, blocked state");
        assert.containsNone(form, '.o-field-widget.badge.badge-success',
            "should not have a success status since selection is the second, blocked state");
        assert.strictEqual(form.$('.o-field-widget.badge.badge-warning').text(), 'Blocked',
    ...
    QUnit.test('label_selection widget in editable list view', async function (assert) {
        ...
        assert.strictEqual(list.$('.o-field-widget.badge:not(:empty)').length, 3,
            "should have three visible status labels");
        assert.containsOnce(list, '.o-field-widget.badge.badge-warning',
            "should have one warning status label");
        assert.strictEqual(list.$('.o-field-widget.badge.badge-warning').text(), 'Blocked',
            "the warning label should read 'Blocked'");
        assert.containsOnce(list, '.o-field-widget.badge.badge-secondary',
            "should have one default status label");
        assert.strictEqual(list.$('.o-field-widget.badge.badge-secondary').text(), 'Normal',
            "the default label should read 'Normal'");
        assert.containsOnce(list, '.o-field-widget.badge.badge-success',
            "should have one success status label");
        assert.strictEqual(list.$('.o-field-widget.badge.badge-success').text(), 'Done',
            "the success label should read 'Done'");

        // switch to edit mode and check the result
        await testUtils.dom.clickFirst(list.$('tbody td:not(.o-list-record-selector)'));
        assert.strictEqual(list.$('.o-field-widget.badge:not(:empty)').length, 3,
            "should have three visible status labels");
        assert.containsOnce(list, '.o-field-widget.badge.badge-warning',
            "should have one warning status label");
    ...
    QUnit.test('statinfo widget formats decimal precision', async function (assert) {
        ...
        var form = await createView({
            ...
            data: this.data,
            arch: '<form string="Partners">' +
                        '<button class="oe-stat-button" name="items" icon="fa-gear">' +
                            '<field name="qux" widget="statinfo"/>' +
                        '</button>' +
                        '<button class="oe-stat-button" name="money" icon="fa-money">' +
        ...
        assert.strictEqual(form.$('.oe-stat-button .o-field-widget.o-stat-info .o-stat-value').eq(0).text(),
            '0.4', "Default precision should be [16,1]");
        assert.strictEqual(form.$('.oe-stat-button .o-field-widget.o-stat-info .o-stat-value').eq(1).text(),
    ...
    QUnit.test('statinfo widget in form view', async function (assert) {
            ...
            arch: '<form string="Partners">' +
                    '<sheet>' +
                        '<div class="oe-button-box" name="buttonBox">' +
                            '<button class="oe-stat-button" name="items"  type="object" icon="fa-gear">' +
        ...
        assert.containsOnce(form, '.oe-stat-button .o-field-widget.o-stat-info',
            "should have one stat button");
        assert.strictEqual(form.$('.oe-stat-button .o-field-widget.o-stat-info .o-stat-value').text(),
            '10', "should have 10 as value");
        assert.strictEqual(form.$('.oe-stat-button .o-field-widget.o-stat-info .o-stat-text').text(),
    ...
    QUnit.test('percentpie widget in form view with value < 50%', async function (assert) {
        ...
        assert.containsOnce(form, '.o-field-percent-pie.o-field-widget .o-pie',
            "should have a pie chart");
        assert.strictEqual(form.$('.o-field-percent-pie.o-field-widget .o-pie .o-pie-value').text(),
            '10%', "should have 10% as pie value since int_field=10");
        assert.ok(_.str.include(form.$('.o-field-percent-pie.o-field-widget .o-pie .o-mask').first().attr('style'),
            'transform: rotate(180deg);'), "left mask should be covering the whole left side of the pie");
        assert.ok(_.str.include(form.$('.o-field-percent-pie.o-field-widget .o-pie .o-mask').last().attr('style'),
    ...
    QUnit.test('percentpie widget in form view with value > 50%', async function (assert) {
        ...
        assert.hasClass(form.$('.o-field-percent-pie.o-field-widget .o-pie .o-mask').last(),'o-full',
    ...
    //     });
    //
    //     assert.containsN(list, '.o-field-percent-pie .o-pie', 5,
    //         "should have five pie charts");
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-pie-value').first().text(),
    //         '10%', "should have 10% as pie value since int_field=10");
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-mask').first().attr('style'),
    //         'transform: rotate(180deg);', "left mask should be covering the whole left side of the pie");
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-mask').last().attr('style'),
    //         'transform: rotate(36deg);', "right mask should be rotated from 360*(10/100) = 36 degrees");
    //
    //     // switch to edit mode and check the result
//    testUtils.dom.click(     list.$('tbody td:not(.o-list-record-selector)').first());
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-pie-value').first().text(),
    //         '10%', "should have 10% as pie value since int_field=10");
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-mask').first().attr('style'),
    ...
    //
    //     // save
//    testUtils.dom.click(     list.$buttons.find('.o-list-button-save'));
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-pie-value').first().text(),
    //         '10%', "should have 10% as pie value since int_field=10");
    //     assert.strictEqual(list.$('.o-field-percent-pie:first .o-pie .o-mask').first().attr('style'),
    //         'transform: rotate(180deg);', "left mask should be covering the whole right side of the pie");
    ...
    QUnit.test('The domain editor should not crash the view when given a dynamic filter', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-read-mode').text(), "This domain is not supported.",
    ...
    QUnit.test('basic domain field usage is ok', async function (assert) {
        ...
        // domain part
        var $domain = form.$(".o-field-domain");
        var $domainAddFirstNodeButton = $domain.find(".o-domain-add-first-node-button");
        ...
        var $fieldSelector = $domain.find(".o-field-selector");
        ...
        var $fieldSelectorPopover = $fieldSelector.find(".o-field-selector-popover");
        assert.ok($fieldSelectorPopover.is(":visible"),
            "field selector popover should be visible");

        assert.containsOnce($fieldSelectorPopover, '.o-field-selector-search input',
        ...
        await testUtils.fields.editAndTrigger($('.o-domain-leaf-value-input'), 2, ['change']);
    ...
    QUnit.test('domain field is correctly reset on every view change', async function (assert) {
        ...
        await testUtils.dom.click(form.$("input.o-field-widget"));
        await testUtils.fields.editInput(form.$("input.o-field-widget"), "partner_type");

        // Refocusing the field selector input should open the popover again
        $fieldSelector = form.$(".o-field-selector");
        $fieldSelector.trigger('focusin');
        $fieldSelectorPopover = $fieldSelector.find(".o-field-selector-popover");
        assert.ok($fieldSelectorPopover.is(":visible"),
            "field selector popover should be visible");
    ...
    QUnit.test('domain field can be reset with a new domain (from onchange)', async function (assert) {
        ...
        // update displayName to trigger the onchange and reset foo
    ...
    QUnit.test('domain field: handle false domain as []', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name=foo]:not(.o-field-empty)').length, 1,
            "there should be a domain field, not considered empty");

        await testUtils.form.clickEdit(form);

        var $warning = form.$('.o-field-widget[name=foo] .text-warning');
    ...
    QUnit.test('basic domain field: show the selection', async function (assert) {
        ...
        var form = await createView({
            ...
            archs: {
                ...
                'partner_type,false,search': '<search><field name="label" string="Name"/></search>',
            },
            resId: 1,
        });
        ...
        assert.strictEqual($('.modal .o-list-view .o-data-row').length, 2,
        ...
        await testUtils.dom.click($('.modal .o-list-view .o-data-row:first .o-data-cell'));
    ...
    QUnit.test('field context is propagated when opening selection', async function (assert) {
        ...
        assert.strictEqual($('.modal .o-data-row').text(), '1214',
    ...
    QUnit.test('domain field: manually edit domain with textarea', async function (assert) {
        ...
        const originalDebug = verp.debug;
        verp.debug = true;
        ...
        await testUtils.fields.editAndTrigger(form.$('.o-domain-debug-input'), "[['id', '<', 40]]", ["change"]);
    ...
    QUnit.test('domain field: manually set an invalid domain with textarea', async function (assert) {
        ...
        await testUtils.fields.editAndTrigger(form.$('.o-domain-debug-input'), "[['abc']]", ["change"]);
        // the count should not be re-computed when editing with the textarea
        assert.strictEqual(form.$(".o_domain_show_selection_button").text().trim(), "2 record(s)");
        assert.verifySteps([]);

        await testUtils.form.clickSave(form);
        assert.hasClass(form.$(".o-field-domain"), "o-field-invalid", "the field is marked as invalid");
        assert.hasClass(form.$(".o-form-view"), "o-form-editable", "the view is still in edit mode");
    ...
    QUnit.test('domain field: does not wait for the count to render', async function (assert) {
        ...
        assert.containsOnce(form, ".o-field-domain-panel .fa-circle-o-notch.fa-spin");
        assert.containsNone(form, ".o-field-domain-panel .o_domain_show_selection_button");

        def.resolve();
        await testUtils.nextTick();

        assert.containsNone(form, ".o-field-domain-panel .fa-circle-o-notch .fa-spin");
        assert.containsOnce(form, ".o-field-domain-panel .o_domain_show_selection_button");
        assert.strictEqual(form.$(".o_domain_show_selection_button").text().trim(), "2 record(s)");
    ...
    QUnit.test('domain field: edit domain with dynamic content', async function (assert) {
        ...
        let rawDomain = `
            [
                ["date", ">=", datetime.datetime.combine(contextToday() + relativedelta(days = -365), datetime.time(0, 0, 0)).to_utc().strftime("%Y-%m-%d %H:%M:%S")]
            ]
        `;
        ...
        assert.strictEqual(form.$(".o-domain-debug-input").val(), rawDomain);

        rawDomain = `
            [
                ["date", ">=", datetime.datetime.combine(contextToday() + relativedelta(days = -1), datetime.time(0, 0, 0)).to_utc().strftime("%Y-%m-%d %H:%M:%S")]
            ]
        `;
        await testUtils.fields.editAndTrigger(form.$('.o-domain-debug-input'), rawDomain, ["change"]);
        await testUtils.form.clickSave(form);
    ...
    QUnit.test('Field ProgressBar: max_value should update', async function (assert) {
        ...
        var form = await createView({
            ...
            mockRPC: function (route, args) {
                if (args.method === 'write') {
                    assert.deepEqual(
                        args.args[1],
                        {int_field: 999, qux: 5, displayName: 'new name'},
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '10 / 2',
            'The initial value of the progress bar should be correct');

        // trigger the onchange
        await testUtils.fields.editInput(form.$('.o-input[name=displayName]'), 'new name');

        assert.strictEqual(form.$('.o-progressbar-value').text(), '999 / 5',
            'The value of the progress bar should be correct after the update');

        await testUtilsDom.click(form.$buttons.find('.o-form-button-save'));
    ...
    QUnit.test('Field ProgressBar: value should not update in readonly mode when sliding the bar', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '99%',
            'Initial value should be correct')

        var $progressBarEl = form.$('.o-progress');
        ...
        assert.verifySteps(["/web/dataset/callKw/partner/read"]);
    ...
    QUnit.test('Field ProgressBar: value should not update in edit mode when sliding the bar', async function (assert) {
        ...
        assert.ok(form.$('.o-form-view').hasClass('o-form-editable'), 'Form in edit mode');
        ...
        assert.strictEqual(form.$('.o-progressbar-value.o-input').val(), "99",
    ...
    QUnit.test('Field ProgressBar: value should update in edit mode when typing in input', async function (assert) {
        ...
        await testUtilsDom.click(form.$('.o-progress'));

        var $valInput = form.$('.o-progressbar-value.o-input');
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '69%',
            'New value should be different than initial after click');
    ...
    QUnit.test('Field ProgressBar: value should update in edit mode when typing in input with field max value', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '99 / 0',
            'Initial value should be correct');
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '69 / 0',
            'New value should be different than initial after click');
    ...
    QUnit.test('Field ProgressBar: max value should update in edit mode when typing in input with field max value', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '99 / 69',
            'New value should be different than initial after click');
    ...
    QUnit.test('Field ProgressBar: Standard readonly mode is readonly', async function (assert) {
        ...
        assert.containsNone(form, '.o-progressbar-value.o-input', 'no input in readonly mode');
    ...
    QUnit.test('Field ProgressBar: write float instead of int works, in locale', async function (assert) {
        ...
        assert.strictEqual(form.$('.o-progressbar-value').text(), '1k%',
            'New value should be different than initial after click');
    ...
    QUnit.test('Field Color: default widget state', async function (assert) {
        ...
        await testUtils.dom.click(form.$('.o-field-color'));
        assert.containsOnce($, '.modal');
        assert.containsNone($('.modal'), '.o-opacity-slider',
            "Opacity slider should not be present");
        assert.containsNone($('.modal'), '.o-opacity-input',
            "Opacity input should not be present");

        await testUtils.dom.click($('.modal .btn:contains("Discard")'));

        assert.strictEqual(document.activeElement, form.$('.o-field-color')[0],
    ...
    QUnit.test('Field Color: behaviour in different views', async function (assert) {
        ...
        await testUtils.dom.click(form.$('.o-field-color:first()'));
        assert.containsNone($(document.body), '.modal',
            "Color field in readonly shouldn't be editable");

        const rowInitialHeight = form.$('.o-data-row:first()').height();

        await testUtils.form.clickEdit(form);
        await testUtils.dom.click(form.$('.o-data-row:first() .o-data-cell:first()'));

        assert.strictEqual(rowInitialHeight, form.$('.o-data-row:first()').height(),
    ...
    QUnit.test('Field Color: pick and reset colors', async function (assert) {
        ...
        assert.strictEqual($('.o-field-color').css('backgroundColor'), 'rgb(255, 0, 0)',
            "Background of the color field should be initially red");

        await testUtils.dom.click(form.$('.o-field-color'));
        await testUtils.fields.editAndTrigger($('.modal .o-hex-input'), '#00ff00', ['change']);
        await testUtils.dom.click($('.modal .btn:contains("Choose")'));

        assert.strictEqual($('.o-field-color').css('backgroundColor'), 'rgb(0, 255, 0)',
    ...
    QUnit.test('FieldColorPicker: can navigate away with TAB', async function (assert) {
        ...
        form.$el.find('a.oe-kanban-color-1')[0].focus();

        form.$el.find('a.oe-kanban-color-1').trigger($.Event('keydown', {
            which: $.ui.keyCode.TAB,
            keyCode: $.ui.keyCode.TAB,
        }));
    ...
    QUnit.test('FieldBadge component on a char field in list view', async function (assert) {
        ...
        const list = await createView({
            ...
            model: 'partner',
            data: this.data,
            arch: `<list><field name="displayName" widget="badge"/></list>`,
        });

        assert.containsOnce(list, '.o-field-badge[name="displayName"]:contains(first record)');
        assert.containsOnce(list, '.o-field-badge[name="displayName"]:contains(second record)');
        assert.containsOnce(list, '.o-field-badge[name="displayName"]:contains(aaa)');
    ...
    QUnit.test('FieldBadge component on a selection field in list view', async function (assert) {
        ...
        assert.containsOnce(list, '.o-field-badge[name="selection"]:contains(Blocked)');
        assert.containsOnce(list, '.o-field-badge[name="selection"]:contains(Normal)');
        assert.containsOnce(list, '.o-field-badge[name="selection"]:contains(Done)');
    ...
    QUnit.test('FieldBadge component on a many2one field in list view', async function (assert) {
        ...
        assert.containsOnce(list, '.o-field-badge[name="trululu"]:contains(first record)');
        assert.containsOnce(list, '.o-field-badge[name="trululu"]:contains(aaa)');
    ...
    QUnit.test('FieldBadge component with decoration-xxx attributes', async function (assert) {
        ...
        assert.containsN(list, '.o-field-badge[name="foo"]', 5);
        assert.containsOnce(list, '.o-field-badge[name="foo"].bg-danger-light');
        assert.containsOnce(list, '.o-field-badge[name="foo"].bg-warning-light');

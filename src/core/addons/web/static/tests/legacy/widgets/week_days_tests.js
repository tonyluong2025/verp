verp.define('web.week_days_tests', function (require) {
    "use strict";
    ...
    QUnit.module('WeeklyRecurrence', {
        ...
        QUnit.test('simple week recurrence widget', async function (assert) {
            ...
            const labelsTexts = [...form.el.querySelectorAll('.o-recurrent-weekday-label')].map(el => el.innerText.trim());

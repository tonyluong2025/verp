verp.define('web.util_tests', function (require) {
"use strict";
...
QUnit.module('core', {}, function () {
    ...
    QUnit.test('roundDecimals', function (assert) {
        ...
        assert.strictEqual(String(roundDi(1.0, 0)), '1');
        assert.strictEqual(String(roundDi(1.0, 1)), '1');
        assert.strictEqual(String(roundDi(1.0, 2)), '1');
        assert.strictEqual(String(roundDi(1.0, 3)), '1');
        assert.strictEqual(String(roundDi(1.0, 4)), '1');
        assert.strictEqual(String(roundDi(1.0, 5)), '1');
        assert.strictEqual(String(roundDi(1.0, 6)), '1');
        assert.strictEqual(String(roundDi(1.0, 7)), '1');
        assert.strictEqual(String(roundDi(1.0, 8)), '1');
        assert.strictEqual(String(roundDi(0.5, 0)), '1');
        assert.strictEqual(String(roundDi(-0.5, 0)), '-1');
        assert.strictEqual(String(roundDi(2.6745, 3)), '2.6750000000000003');
        assert.strictEqual(String(roundDi(-2.6745, 3)), '-2.6750000000000003');
        assert.strictEqual(String(roundDi(2.6744, 3)), '2.674');
        assert.strictEqual(String(roundDi(-2.6744, 3)), '-2.674');
        assert.strictEqual(String(roundDi(0.0004, 3)), '0');
        assert.strictEqual(String(roundDi(-0.0004, 3)), '0');
        assert.strictEqual(String(roundDi(357.4555, 3)), '357.456');
        assert.strictEqual(String(roundDi(-357.4555, 3)), '-357.456');
        assert.strictEqual(String(roundDi(457.4554, 3)), '457.455');
        assert.strictEqual(String(roundDi(-457.4554, 3)), '-457.455');
    });
    ...
    QUnit.test('roundPrecision', function (assert) {
        ...
        assert.strictEqual(String(roundPr(1.0, 1)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.1)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.01)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.001)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.0001)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.00001)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.000001)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.0000001)), '1');
        assert.strictEqual(String(roundPr(1.0, 0.00000001)), '1');
        assert.strictEqual(String(roundPr(0.5, 1)), '1');
        assert.strictEqual(String(roundPr(-0.5, 1)), '-1');
        assert.strictEqual(String(roundPr(2.6745, 0.001)), '2.6750000000000003');
        assert.strictEqual(String(roundPr(-2.6745, 0.001)), '-2.6750000000000003');
        assert.strictEqual(String(roundPr(2.6744, 0.001)), '2.674');
        assert.strictEqual(String(roundPr(-2.6744, 0.001)), '-2.674');
        assert.strictEqual(String(roundPr(0.0004, 0.001)), '0');
        assert.strictEqual(String(roundPr(-0.0004, 0.001)), '0');
        assert.strictEqual(String(roundPr(357.4555, 0.001)), '357.456');
        assert.strictEqual(String(roundPr(-357.4555, 0.001)), '-357.456');
        assert.strictEqual(String(roundPr(457.4554, 0.001)), '457.455');
        assert.strictEqual(String(roundPr(-457.4554, 0.001)), '-457.455');
        assert.strictEqual(String(roundPr(-457.4554, 0.05)), '-457.45000000000005');
        assert.strictEqual(String(roundPr(457.444, 0.5)), '457.5');
        assert.strictEqual(String(roundPr(457.3, 5)), '455');
        assert.strictEqual(String(roundPr(457.5, 5)), '460');
        assert.strictEqual(String(roundPr(457.1, 3)), '456');
    });

verp.define('web.dialog_tests', function (require) {
"use strict";
...
QUnit.module('core', {}, function () {
    ...
    QUnit.test("Closing confirm dialog without using buttons calls cancel callback", async function (assert) {
        ...
        var parent = await createEmptyParent();
        var options = {
            confirmCallback: testPromise.reject,
    ...
    QUnit.test("Closing alert dialog without using buttons calls confirm callback", async function (assert) {
        ...
        var parent = await createEmptyParent();
        var options = {
            confirmCallback: testPromise.resolve,
        };
    ...
    QUnit.test("Ensure onAttachCallback and onDetachCallback are properly called", async function (assert) {
        assert.expect(4);
        ...
        await testUtils.dom.click($('.modal[role="dialog"] .btn-primary'));
        assert.verifySteps(['onDetachCallback']);

verp.define('web.widget_tests', function (require) {
"use strict";
...
QUnit.module('core', {}, function () {
    ...
    QUnit.test("calling _rpc on destroyed widgets", async function (assert) {
        ...
        assert.ok(!def, "triggerUp is not performed and the call returns a " +
            "promise that remains pending forever");
    ...
    QUnit.test("calling doHide on a widget destroyed before being rendered", async function (assert) {
        assert.expect(1);

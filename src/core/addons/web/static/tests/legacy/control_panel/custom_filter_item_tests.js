verp.define('web.filter_menu_generator_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {
        ...
        QUnit.test('basic rendering', async function (assert) {
            ...
            assert.hasClass(cfi.el, 'o-add-custom_filter_menu');
            assert.strictEqual(cfi.el.children.length, 1);

            await toggleAddCustomFilterStandalone(cfi);

            // Single condition
            assert.containsOnce(cfi, '.o-filter-condition');
            assert.containsOnce(cfi, '.o-filter-condition select.o-generator-menu-field');
            assert.containsOnce(cfi, '.o-filter-condition select.o-generator-menu-operator');
            assert.containsOnce(cfi, '.o-filter-condition span.o-generator-menu-value');
            assert.containsNone(cfi, '.o-filter-condition .o-or-filter');
            assert.containsNone(cfi, '.o-filter-condition .o-generator-menu-delete');

            // no deletion allowed on single condition
            assert.containsNone(cfi, '.o-filter-condition > i.o-generator-menu-delete');

            // Buttons
            assert.containsOnce(cfi, 'button.o_apply_filter');
            assert.containsOnce(cfi, 'button.o-add-condition');

            assert.containsOnce(cfi, '.o-filter-condition');

            await cpHelpers.addCondition(cfi);

            assert.containsN(cfi, '.o-filter-condition', 2);
            assert.containsOnce(cfi, '.o-filter-condition .o-or-filter');
            assert.containsN(cfi, '.o-filter-condition .o-generator-menu-delete', 2);
        ...
        QUnit.test('custom OR filter presets new condition from preceding', async function (assert) {
            ...
            const fieldSecondValue = cfi.el.querySelector('.o-generator-menu-field option:nth-of-type(2)').value;
            const operatorSecondValue = cfi.el.querySelector('.o-generator-menu-operator option:nth-of-type(2)').value;
            ...
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), fieldSecondValue);
            ...
            assert.strictEqual(
                cfi.el.querySelector('.o-filter-condition:nth-of-type(2) .o-generator-menu-field').value,
                fieldSecondValue
            );
            assert.strictEqual(
                cfi.el.querySelector('.o-filter-condition:nth-of-type(2) .o-generator-menu-operator').value,
                operatorSecondValue
            );
        ...
        QUnit.test('binary field: basic search', async function (assert) {
            ...
            await toggleAddCustomFilterStandalone(cfi);
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'binary_field');
        ...
        QUnit.test('selection field: default and updated value', async function (assert) {
            ...
            await toggleAddCustomFilterStandalone(cfi);
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'color');
            await cpHelpers.applyFilter(cfi);
            ...
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'color');
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-value select'), 'white');
            await cpHelpers.applyFilter(cfi);
        ...
        QUnit.test('adding a simple filter works', async function (assert) {
            ...
            await toggleAddCustomFilterStandalone(cfi);
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'boolean_field');
            await cpHelpers.applyFilter(cfi);
        ...
        QUnit.test('filtering by ID interval works', async function (assert) {
            ...
            class MockedSearchModel extends ActionModel {
                dispatch(method, ...args) {
                    ...
                    let domain = vjUtils.assembleDomains([preFilter.domain]);
        ...
        QUnit.test('custom filter datetime with equal operator', async function (assert) {
            ...
            await toggleAddCustomFilterStandalone(cfi);
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-generator-menu-field'), 'date_time_field');

            assert.strictEqual(cfi.el.querySelector('.o-generator-menu-field').value, 'date_time_field');
            assert.strictEqual(cfi.el.querySelector('.o-generator-menu-operator').value, 'between');

            await cpHelpers.editConditionOperator(cfi, 0, '=');
            await testUtils.fields.editSelect(cfi.el.querySelector('.o-filter-condition span.o-generator-menu-value input'), '02/22/2017 11:00:00'); // in TZ
            await cpHelpers.applyFilter(cfi);
        ...
        QUnit.test('custom filter datetime between operator', async function (assert) {
            ...
            const valueInputs = cfi.el.querySelectorAll('.o-generator-menu-value .o-input');
        ...
        QUnit.test('input value parsing', async function (assert) {
            ...
            const [floatInput, idInput] = cfi.el.querySelectorAll('.o-generator-menu-value .o-input');
        ...
        QUnit.test('input value parsing with language', async function (assert) {
            ...
            const cfi = await createComponent(CustomFilterItem, {
                ...
                env: {
                    searchModel: new ActionModel(),
                    _t: Object.assign(s => s, { database: { parameters: { decimalPoint: "," } }}),
                },
                translateParameters: {
                    decimalPoint: ",",
                    thousandsSep: "",
            ...
            const [floatInput] = cfi.el.querySelectorAll('.o-generator-menu-value .o-input');

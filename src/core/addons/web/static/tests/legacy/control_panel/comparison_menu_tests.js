verp.define('web.comparison_menu_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {
        ...
        QUnit.test('simple rendering', async function (assert) {
            ...
            assert.containsOnce(controlPanel, ".dropdown.o-filter-menu");
            assert.containsNone(controlPanel, ".dropdown.o-comparison-menu");
            ...
            assert.containsOnce(controlPanel, 'div.o-comparison-menu > button i.fa.fa-adjust');
            assert.strictEqual(controlPanel.el.querySelector('div.o-comparison-menu > button span').innerText.trim(), "Comparison");

            await cpHelpers.toggleComparisonMenu(controlPanel);

            const comparisonOptions = [...controlPanel.el.querySelectorAll(
                '.o-comparison-menu .o-menu-item'
            )];

verp.define('web.groupby_menu_generator_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {}, function () {
        ...
        QUnit.test('click on add custom group toggle group selector', async function (assert) {
            ...
            assert.hasClass(cgi.el, 'o-add-custom_group_menu');
            assert.strictEqual(cgi.el.children.length, 1);

            await testUtils.dom.click(cgi.el.querySelector('.o-add-custom_group_menu .dropdown-toggle'));

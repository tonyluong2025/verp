verp.define("web/static/tests/control_panel/control_panel_model_extension_tests.js", function (require) {
    "use strict";
        ...
        QUnit.test('ir.filter values', async function (assert) {
            ...
            const arch = `
                <search>
                    ...
                    <filter name="groupby" string="Goodbye" context="{'groupby': 'foo'}"/>
                    <field name="bar"/>
                </search>`;
            const fields = this.fields;

verp.define('web.filter_menu_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Components', {
        ...
        QUnit.test('simple rendering with no filter', async function (assert) {
            ...
            assert.containsOnce(controlPanel, '.o-add-custom_filter_menu');
        ...
        QUnit.test('simple rendering with a single filter', async function (assert) {
            ...
            assert.containsOnce(controlPanel, 'div.o-add-custom_filter_menu');
        ...
        QUnit.test('should have Date and ID field proposed in that order in "Add custom Filter" submenu', async function (assert) {
            ...
            const optionEls = controlPanel.el.querySelectorAll('.o-filter-condition select.o-generator-menu-field option');
        ...
        QUnit.test('toggle a "simple" filter in filter menu works', async function (assert) {
            ...
            assert.containsOnce(controlPanel.el.querySelector('.o-searchview .o-searchview-facet'),
                'span.fa.fa-filter.o-searchview-facet-label');
        ...
        QUnit.test('arch order of groups of filters preserved', async function (assert) {
            ...
            await cpHelpers.toggleFilterMenu(controlPanel);
            assert.containsN(controlPanel, '.o-filter-menu .o-menu-item', 11);

            const menuItemEls = controlPanel.el.querySelectorAll('.o-filter-menu .o-menu-item');

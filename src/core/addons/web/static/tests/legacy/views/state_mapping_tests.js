...
import { mock } from "web.testUtils";
...
QUnit.module("Views", (hooks) => {
    hooks.beforeEach(async () => {
            ...
            views: {
                ...
                "foo,false,search": `
                    <search>
                        ...
                        <filter name="groupby_dateField" string="Date GroupBy" context="{ 'groupby': 'date_field' }"/>
                    </search>
                `,
            },
        };
        ...
        ToyView.displayName = _lt("Toy view");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await doAction(webClient, {
                ...
                context: {
                    searchDefault_foo: "ABC",
                    searchDefault_true_domain: 1,
                    searchDefault_date_domain: 1,
                    searchDefault_groupby_bar: 50,
                    searchDefault_groupby_dateField: 1,
                },
            });

            assert.containsOnce(webClient, ".o-switch-view.o_toy.active");
            assert.deepEqual(
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            serverData.views[
                "foo,1,legacy_toy"
            ] = `<legacy_toy jsClass="legacy_toy_with_extension"/>`;

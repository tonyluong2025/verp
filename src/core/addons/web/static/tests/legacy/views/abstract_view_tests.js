verp.define('web.abstract_view_tests', function (require) {
"use strict";
...
QUnit.module('Views', {
    ...
    QUnit.test('groupby from context can be a string, instead of a list of strings', async function (assert) {
        assert.expect(1);

verp.define('web.qweb_view_tests', function (require) {
"use strict";

const utils = require('web.testUtils');
...
QUnit.module("Views", {
    ...
    QUnit.test("basic", async function (assert) {
        ...
        const content = webClient.el.querySelector('.o-content');

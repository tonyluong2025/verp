verp.define('web.abstract_view_banner_tests', function (require) {
"use strict";
...
QUnit.module('Views', {
        ...
        QUnit.test("The banner should be fetched from the route", function (assert) {
            ...
            createView({
                ...
                model: 'test_model',
                data: this.data,
                arch: '<test bannerRoute="/module/hello_banner"/>',
                ...
                await testUtils.dom.click(view.$('.o-onboarding-btn-close'));  // click on close to remove banner
                await testUtils.dom.click(view.$('.o-technical-modal .btn-primary:contains("Remove")'));  // click on button remove from techinal modal
                assert.strictEqual(view.$('.o-onboarding-container.show').length, 0,

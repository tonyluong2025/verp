...
QUnit.module("Search", (hooks) => {
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.containsNone(controlPanel, ".o-add-custom_group_menu");
        }
    );
    ...
    QUnit.test("simple rendering with a single groupby", async function (assert) {
        ...
        const controlPanel = await makeWithSearch({
            ...
            searchViewArch: `
                    <search>
                        <filter string="Foo" name="groupby_foo" context="{'groupby': 'foo'}"/>
                    </search>
                `,
        });
        ...
        assert.strictEqual(controlPanel.el.querySelector(".o-menu-item").innerText.trim(), "Foo");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            const controlPanel = await makeWithSearch({
                ...
                `,
                context: { searchDefault_groupby_foo: 1 },
            });

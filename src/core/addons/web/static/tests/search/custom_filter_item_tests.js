...
QUnit.module("Search", (hooks) => {
    ...
    QUnit.test("basic rendering", async function (assert) {
        ...
        const customFilterItem = controlPanel.el.querySelector(".o-add-custom_filter_menu");
        ...
        // Single condition
        assert.containsOnce(customFilterItem, ".o-filter-condition");
        assert.containsOnce(
            customFilterItem,
            ".o-filter-condition > select.o-generator-menu-field"
        );
        assert.containsOnce(
            customFilterItem,
            ".o-filter-condition > select.o-generator-menu-operator"
        );
        assert.containsOnce(customFilterItem, ".o-filter-condition > span.o-generator-menu-value");
        assert.containsNone(customFilterItem, ".o-filter-condition .o-or-filter");
        assert.containsNone(customFilterItem, ".o-filter-condition .o-generator-menu-delete");

        // no deletion allowed on single condition
        assert.containsNone(customFilterItem, ".o-filter-condition > i.o-generator-menu-delete");

        // Buttons
        assert.containsOnce(customFilterItem, "button.o_apply_filter");
        assert.containsOnce(customFilterItem, "button.o-add-condition");

        assert.containsOnce(customFilterItem, ".o-filter-condition");

        await click(customFilterItem, "button.o-add-condition");

        assert.containsN(customFilterItem, ".o-filter-condition", 2);
        assert.containsOnce(customFilterItem, ".o-filter-condition .o-or-filter");
        assert.containsN(customFilterItem, ".o-filter-condition .o-generator-menu-delete", 2);
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            const optionEls = controlPanel.el.querySelectorAll(
                ".o-filter-condition > select.o-generator-menu-field option"
            );
    ...
    QUnit.test("custom OR filter presets new condition from preceding", async function (assert) {
        ...
        const secondFieldName = controlPanel.el.querySelector(
            ".o-generator-menu-field option:nth-of-type(2)"
        ).value;
        const secondOperator = controlPanel.el.querySelector(
            ".o-generator-menu-operator option:nth-of-type(2)"
        ).value;
        ...
        assert.strictEqual(
            controlPanel.el.querySelector(
                ".o-filter-condition:nth-of-type(2) .o-generator-menu-field"
            ).value,
            secondFieldName
        );
        assert.strictEqual(
            controlPanel.el.querySelector(
                ".o-filter-condition:nth-of-type(2) .o-generator-menu-operator"
            ).value,
            secondOperator
        );
    });
    ...
    QUnit.test("adding a simple filter works", async function (assert) {
        ...
        assert.containsNone(controlPanel, ".o-menu-item");
        assert.containsOnce(controlPanel, ".o-add-custom_filter_menu button.dropdown-toggle");
        // the 'Add Custom Filter' menu should be closed;
        assert.containsNone(controlPanel, ".o-add-custom_filter_menu .dropdown-menu");

        await toggleAddCustomFilter(controlPanel);
        // the 'Add Custom Filter' menu should be open;
        assert.containsOnce(controlPanel, ".o-add-custom_filter_menu .dropdown-menu");
        ...
        assert.containsOnce(controlPanel, ".o-menu-item");
        assert.containsOnce(controlPanel, ".o-add-custom_filter_menu button.dropdown-toggle");
    ...
    QUnit.test("selection field: default and updated value", async function (assert) {
        ...
        assert.containsN(controlPanel, ".o-menu-item", 0);
        ...
        assert.containsN(controlPanel, ".o-menu-item", 1);
        ...
        assert.containsN(controlPanel, ".o-menu-item", 2);
    ...
    QUnit.test("custom filter datetime with equal operator", async function (assert) {
        ...
        assert.strictEqual(
            controlPanel.el.querySelector(".o-generator-menu-field").value,
            "date_time_field"
        );
        assert.strictEqual(
            controlPanel.el.querySelector(".o-generator-menu-operator").value,
            "between"
        );
        assert.deepEqual(
            [...controlPanel.el.querySelectorAll(".o-generator-menu-value input")].map(
                (v) => v.value
            ),
    ...
    QUnit.test("input value parsing", async function (assert) {
        ...
        const [floatInput, idInput] = controlPanel.el.querySelectorAll(
            ".o-generator-menu-value .o-input"
        );
    ...
    QUnit.test("input value parsing with language", async function (assert) {
        ...
        const [floatInput] = controlPanel.el.querySelectorAll(".o-generator-menu-value .o-input");
    ...
    QUnit.test("add custom filter with multiple values", async function (assert) {
        ...
        const thirdcondition = controlPanel.el.querySelectorAll(".o-filter-condition")[2];

        await click(thirdcondition, ".o-generator-menu-delete");
        await applyFilter(controlPanel);
    ...
    QUnit.test("delete button is visible", async function (assert) {
        ...
        assert.containsN(
            controlPanel,
            "i.o-generator-menu-delete.fa-trash-o",
            2,

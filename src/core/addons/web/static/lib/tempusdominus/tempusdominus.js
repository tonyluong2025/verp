...
var DateTimePicker = function ($, moment) {
    ...
    var NAME = 'datetimepicker',
        ...
        Selector = {
        // /!\ Verp PATCH: ensure the datetimepickers can be toggled only after
        // the Verp lazy loader finished loading all lazy scripts. Another
        ...
        DATA_TOGGLE: 'body:not(.o-lazy-js-waiting) [data-toggle="' + DATA_KEY + '"]'
    },
        ClassName = {
        INPUT: NAME + '-input'
    },
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._change = function _change(e) {
            ...
            this._setValue(parsedDate, 0); // Verp FIX: if a valid date is replaced by an invalid one, lib will crash, see https://github.com/tempusdominus/bootstrap-4/issues/223
        ...
        DateTimePicker.prototype._notifyEvent = function _notifyEvent(e) {
            // /!\ Verp FIX: these next conditions have been modified by verp
        ...
        DateTimePicker.prototype._getLastPickedDate = function _getLastPickedDate() {
            return this._dates[this._getLastPickedDateIndex()] || this.getMoment(); // FIXME changed by Verp
        };
...
var TempusDominusBootstrap4 = function ($) {
    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._place = function _place(e) {
            ...
            // /!\ Verp FIX: the 3 next lines have been *added* by verp
    ...
    */
    ...
    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function () {
        ...
        // /!\ Verp FIX: check on 'config' existence added by verp

...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("VerpBeforeTestHook", "VerpAfterTestHook"); // Verp customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("VerpBeforeTestHook"); // Verp customization
  	...
  	finish: function finish() {
        ...
        emit("VerpAfterTestHook", this); // Verp customization

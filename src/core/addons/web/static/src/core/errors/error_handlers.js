...
/**
 * @typedef {import("../../env").VerpEnv} VerpEnv
 * @typedef {import("./error_service").UncaughtError} UncaughError
 */

const errorHandlerRegistry = registry.category("errorHandlers");
const errorDialogRegistry = registry.category("errorDialogs");
const errorNotificationRegistry = registry.category("errorNotifications");
...
export function rpcErrorHandler(env, error, originalError) {
    ...
    if (originalError instanceof RPCError) {
        ...
        if (!ErrorComponent && originalError.data.context) {
            const exceptionClass = originalError.data.context.exceptionClass;

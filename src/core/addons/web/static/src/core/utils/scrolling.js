 ...
 * In desktop, the relevant element is the .o-content of the action.
...
function getScrollableElement(component) {
    if (component.env.isSmall) {
        ...
        return component.el.querySelector(".o-action-manager .o-content");
    }
}

/**
 * Retrieves the current top and left scroll position. By default, the scrolling
 * area is the '.o-content' main div. In mobile, it is the body.
 *
 * @param {Component} an action Component containing an .o-content scrollable
 *   area.
 */
 ...
 * scrolling area is the '.o-content' main div. In mobile, it is the body.
 *
 * @param {Component} an action Component containing an .o-content scrollable
 *   area.
 * @param {Object} offset

...
export const scrollerService = {
    start(env) {
         ...
         * Since verp use hashtag to represent the current state of the view, we can't
        ...
        browser.addEventListener("click", (ev) => {
            ...
            const disableAnchor = link.attributes.getNamedItem("disableAnchor");
            ...
            if (href) {
                if (href.value[0] === "#") {
                    ...
                    let matchingEl = null;
                    try {
                        matchingEl = document.querySelector(`.o-content #${href.value.substr(1)}`);
                    } catch (e) {

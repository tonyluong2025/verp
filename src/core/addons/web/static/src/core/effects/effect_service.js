...
/**
 * Handles effect of type "rainbowMan". If the effects aren't disabled, returns
 ...
 * @param {boolean} [params.imgurl="/web/static/img/smile.svg"]
...
function rainbowMan(env, params = {}) {
    ...
    if (env.services.user.showEffect) {
        return {
            ...
            props: {
                imgurl: params.imgurl || "/web/static/img/smile.svg",
...
effectRegistry.add("rainbowMan", rainbowMan);
...
export const effectService = {
    start(env) {
        ...
        registry.category("mainComponents").add("EffectContainer", {
         ...
         * @param {string} [params.type="rainbowMan"] the effect to display
         */
        function add(params) {
            const type = params.type || "rainbowMan";

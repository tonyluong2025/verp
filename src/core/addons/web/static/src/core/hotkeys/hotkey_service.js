...
export const hotkeyService = {
    dependencies: ["ui"],
    // Be aware that all verp hotkeys are designed with this modifier in mind,
    ...
    start(env, { ui }) {
        ...
        function addHotkeyOverlays() {
            ...
            for (const el of getVisibleElements(ui.activeElement, "[data-hotkey]:not(:disabled)")) {
                ...
                overlay.className = "o-web-hotkey-overlay";
        ...
        function removeHotkeyOverlays(event) {
            ...
            for (const overlay of document.querySelectorAll(".o-web-hotkey-overlay")) {
                overlay.remove();
            }

(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to Verp legacy
     * events.
     */
    verp.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[verp.widgetSymbol]) {
            this.env[verp.widgetSymbol](evType);
        }

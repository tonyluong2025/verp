verp.define('web.CustomFavoriteItem', function (require) {
    "use strict";
    ...
    class CustomFavoriteItem extends Component {
        constructor() {
            ...
            this.useByDefaultId = `oFavoriteUseByDefault_${favId}`;
            this.shareAllUsersId = `oFavoriteShareAllUsers_${favId}`;

            this.descriptionRef = useRef('description');
            this.model = useModel('searchModel');
            this.interactive = true;
            this.state = useState({
                description: this.env.action.label || "",
                isDefault: false,
                isShared: false,
            });

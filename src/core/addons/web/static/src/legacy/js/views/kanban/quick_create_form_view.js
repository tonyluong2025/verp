verp.define('web.QuickCreateFormView', function (require) {
"use strict";
...
var QuickCreateFormRenderer = FormRenderer.extend({
    ...
    start: async function () {
        ...
        this.$el.addClass('o-xxs-form-view');
        this.$el.removeClass('o-xxl-form-view');
    },
    ...
    _onNavigationMove: function (ev) {
        ...
        if (direction === 'cancel' || direction === 'nextLine') {
            ev.stopPropagation();
            this.triggerUp(direction === 'cancel' ? 'cancel' : 'add');
        } else {

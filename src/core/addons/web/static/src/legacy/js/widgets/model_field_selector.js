verp.define("web.ModelFieldSelector", function (require) {
"use strict";
...
core.bus.on('clearCache', null, function () {
...
var ModelFieldSelector = Widget.extend({
    ...
    editionEvents: {
        ...
        "click .o-field-selector-close": "_onCloseClick",

        // Handle popover field navigation
        "click .o-field-selector-prev-page": "_onPrevPageClick",
        "click .o-field-selector-next-page": "_onNextPageClick",
        "click li.o-field-selector-select-button": "_onLastFieldClick",

        // Handle a direct change in the debug input
        "change input.o-field-selector-debug": "_onDebugInputChange",

        // Handle a change in the search input
        "keyup .o-field-selector-search > input": "_onSearchInputChange",

        // Handle keyboard and mouse navigation to build the field chain
        "mouseover li.o-field-selector-item": "_onItemHover",
        "keydown": "_onKeydown",
    },
    /**
     * @constructor
     ...
     */
    start: function () {
        this.$value = this.$(".o-field-selector-value");
        this.$popover = this.$(".o-field-selector-popover");
        this.$input = this.$popover.find(".o-field-selector-popover-footer > input");
        this.$searchInput = this.$popover.find(".o-field-selector-search > input");
        this.$valid = this.$(".o-field-selector-warning");
    ...
    _getModelFieldsFromCache: function (model, filters) {
        ...
        if (!def) {
            def = modelFieldsCache.cacheDefs[model] = this._rpc({
                    ...
                    context: this.getSession().userContext,
                })
    ...
    _hidePopover: function () {
        ...
        if (this.dirty) {
            this.dirty = false;
            this.triggerUp("fieldChainChanged", {chain: this.chain});
        }
    },
    /**
    ...
    _render: function () {
        ...
        this.$(".o-field-selector-popover-header .o-field-selector-title").text(title);
        ...
        this.$(".o-field-selector-page").replaceWith(core.qweb.render(this.template + ".page", {
            lines: lines,
    ...
    _onItemHover: function (e) {
        this.$("li.o-field-selector-item").removeClass("active");
    ...
    _onKeydown: function (e) {
        ...
        switch (e.which) {
            ...
            case $.ui.keyCode.DOWN:
                e.preventDefault();
                var $active = this.$("li.o-field-selector-item.active");
                var $to = $active[e.which === $.ui.keyCode.DOWN ? "next" : "prev"](".o-field-selector-item");
                if ($to.length) {
                    $active.removeClass("active");
                    $to.addClass("active");
                    this.$popover.focus();

                    var $page = $to.closest(".o-field-selector-page");
                    var fullHeight = $page.height();
                    var elPosition = $to.position().top;
                    var elHeight = $to.outerHeight();
            ...
            case $.ui.keyCode.RIGHT:
                ...
                e.preventDefault();
                var name = this.$("li.o-field-selector-item.active").data("name");
                if (name) {
            ...
            case $.ui.keyCode.ENTER:
                ...
                e.preventDefault();
                this._selectField(this._getLastPageField(this.$("li.o-field-selector-item.active").data("name")));
                break;
        }
    }
});

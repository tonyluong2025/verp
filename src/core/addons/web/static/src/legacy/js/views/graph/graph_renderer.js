verp.define("web/static/src/js/views/graph/graph_renderer", function (require) {
    "use strict";
    ...
    class GraphRenderer extends AbstractRenderer {
        constructor() {
            ...
            this.fakeDataLabel = [""];
            this.sampleDataTargets = [".o-graph-canvas-container"];
        ...
        _onGraphClicked(ev) {
            ...
            if (domain) {
                this.trigger("openView", { domain: domain[_index] });
            }
        }

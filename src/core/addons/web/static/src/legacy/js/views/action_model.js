/** @verp-module alias=web.ActionModel **/
    ...
    class ActionModel extends Model {
         ...
         */
        _getQuery() {
            const evalContext = this.env.session.userContext;
            const contexts = this.__get(null, "context");
            const domains = this.__get(null, "domain");
            const query = {
                context: vjUtils.eval("contexts", contexts, evalContext),
                domain: Domain.prototype.normalizeArray(
                    vjUtils.eval("domains", domains, evalContext)
                ),

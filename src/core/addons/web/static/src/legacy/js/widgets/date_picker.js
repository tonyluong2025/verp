verp.define('web.datepicker', function (require) {
"use strict";
...
var DateWidget = Widget.extend({
    ...
    events: {
        ...
        'change .o-datepicker-input': 'changeDatetime',
    ...
    init: function (parent, options) {
        ...
        this.options = _.extend({
            ...
            format : this.typeOfDate === 'datetime' ? time.getLangDatetimeFormat() : time.getLangDateFormat(),
     ...
     */
    start: function () {
        this.$input = this.$('input.o-datepicker-input');
        this.__libInput++;
    ...
    changeDatetime: function () {
        if (this.__libInput > 0) {
            if (this.options.warnFuture) {
                this._warnFuture(this.getValue());
            }
            this.trigger("datetimeChanged");
            return;
        }
     ...
     * unwanted effects (like triggering 'fieldChanged' events)
     */
    focus: function () {
        this.__libInput++;
        this.$input.focus();
    ...
    setValue: function (value) {
        ...
        var formattedValue = value ? this._formatClient(value) : null;
        this.$input.val(formattedValue);
    ...
    _warnFuture: function (currentDate) {
        if (!this.$warning) {
            this.$warning = $('<span>', {
                class: 'fa fa-exclamation-triangle o-tz-warning o-datepicker-warning',
            });
    ...
    _formatClient: function (v) {
        return fieldUtils.format[this.typeOfDate](v, null, {timezone: false});
    },
    /**
     * @private
    ...
    _parseClient: function (v) {
        return fieldUtils.parse[this.typeOfDate](v, null, {timezone: false});
    },
    /**
     * @private
     * @param {Moment|false} value
     ...
     * might have unwanted effects (like triggering 'fieldChanged' events in

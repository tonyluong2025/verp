verp.define('web.ControlPanelX2Many', function (require) {
     ...
     * pager only). We still extend the main version for the injection of `cpContent`
     * keys.
    ...
    ControlPanelX2Many.props = {
        cpContent: { type: Object, optional: 1 },
        pager: Object,
    };

verp.define('web.ServiceProviderMixin', function (require) {
"use strict";
...
var ServiceProviderMixin = {
    ...
    init: function (parent) {
        ...
        this.on('callService', this, this._callService.bind(this));
...
verp.define('web.ServicesMixin', function (require) {
"use strict";
...
var ServicesMixin = {
    ...
    loadFieldView: function (modelName, context, viewId, viewType, options) {
        return this.loadViews(modelName, context, [[viewId, viewType]], options).then(function (result) {

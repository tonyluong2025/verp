/* global ace */
verp.define('web.basicFields', function (require) {
"use strict";
...
var deprecatedFields = require('web.basicFields.deprecated');
...
var TranslatableFieldMixin = {
    ...
    _renderTranslateButton: function () {
        if (_t.database.multiLang && this.field.translate) {
            var lang = _t.database.parameters.code.split('_')[0].toUpperCase();
            return $(`<span class="o-field-translate btn btn-link">${lang}</span>`)
...
var DebouncedField = AbstractField.extend({
    ...
    init: function () {
        ...
        // fieldChanged in commitChanges if the user didn't change anything
        this._isDirty = false;
        if (this.mode === 'edit') {
            if (this.DEBOUNCE) {
...
var InputField = DebouncedField.extend({
    customEvents: _.extend({}, DebouncedField.prototype.customEvents, {
...
var NumericField = InputField.extend({
     ...
     * This function uses vjEval to safe eval the formula.
    ...
    _evalFormula: function (expr, context) {
        ...
        return vjUtils.vjEval(safeEvalString, context);
    },
    ...
    _onKeydown(ev) {
        ...
        if (kbdEvt && utils.isNumpadDecimalSeparatorKey(kbdEvt)) {
            ...
            const point = _t.database.parameters.decimalPoint;
...
var FieldChar = InputField.extend(TranslatableFieldMixin, {
    ...
    _renderEdit: function () {
        ...
        if (this.field.translate) {
            ...
            this.$el.addClass('o-field-translate');
        }
        return def;
    },
    /**
...
var FieldDaterange = InputField.extend({
    ...
    init: function () {
        ...
        this.daterangePickerOptions = _.defaults(
            ...
            this.nodeOptions.pickerOptions || {},
            {
                ...
                timePicker24Hour: _t.database.parameters.timeFormat.search('%H') !== -1,
        ...
        this.relatedEndDate = this.nodeOptions.relatedEndDate;
        this.relatedStartDate = this.nodeOptions.relatedStartDate;
    },
    /**
     * @override
     */
    ...
    isValid: function () {
        ...
        try {
            return fieldUtils.parse[this.formatType](value, this.field, { timezone: true }) || true;
        } catch (error) {
            return false;
        }
    },
    ...
    _getValue: function () {
        try {
            ...
            this.removeInvalidClass();
            return fieldUtils.parse[this.formatType](this.$input.val(), this.field, { timezone: true });
        } catch (error) {
            this.setInvalidClass();
            return false;
        }
    ...
    _applyChanges: function (ev, picker) {
        var changes = {};
        var displayStartDate = fieldUtils.format[this.formatType](picker.startDate, {}, {timezone: false});
        var displayEndDate = fieldUtils.format[this.formatType](picker.endDate, {}, {timezone: false});
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, Verp will consider it as UTC. To fix this added browser
...
var FieldDate = InputField.extend({
    ...
    start: function () {
        ...
        if (this.mode === 'edit') {
            ...
            this.datewidget.on('datetimeChanged', this, function () {
     ...
     * intercepted, and don't produce unwanted 'fieldChanged' events.
     *
     * @override
     */
    activate: function () {
    ...
    async _onKeydown(ev) {
        ...
        if (ev.which === $.ui.keyCode.ENTER) {
            ...
            try {
                ...
                if (this.datewidget.typeOfDate === "datetime") {
...
const RemainingDays = AbstractField.extend({
    ...
    async _renderEdit() {
        ...
        this.datewidget = this._makeDatePicker();
        this.datewidget.on('datetimeChanged', this, () => {
...
var FieldMonetary = NumericField.extend({
    ...
    className: 'o-field-monetary o-field-number',
    tagName: 'span',
    ...
    /**
     * Float fields using a monetary widget have an additional currencyField
    ...
    init: function () {
        ...
        this.formatOptions.fieldDigits = this.nodeOptions.fieldDigits;
    },
    ...
    _setCurrency: function () {
        var currencyField = this.nodeOptions.currencyField || this.field.currencyField || 'currencyId';
        var currencyID = this.record.data[currencyField] && this.record.data[currencyField].resId;
        this.currency = session.getCurrency(currencyID);
...
var FieldInteger = NumericField.extend({
    ...
    className: 'o-field-integer o-field-number',
...
var FieldFloat = NumericField.extend({
    ...
    className: 'o-field-float o-field-number',
    supportedFieldTypes: ['float'],
    isQuickEditable: true,

    /**
     * Float fields have an additional precision parameter that is read from
     * either the field node in the view or the field javascript definition itself.
     *
     * @override
     */
    init: function () {
...
var FieldFloatTime = FieldFloat.extend({
    ...
    // attrs must be set to 'floatTime', so the formatType is automatically
    // 'floatTime', but for the sake of clarity, we explicitely define a
    // FieldFloatTime widget with formatType = 'floatTime'.
    formatType: 'floatTime',
    isQuickEditable: true,

    init: function () {
        this._super.apply(this, arguments);
        this.formatType = 'floatTime';
    },
    /**
...
var FieldFloatFactor = FieldFloat.extend({
    supportedFieldTypes: ['float'],
    className: 'o-field-float-factor',
    formatType: 'floatFactor',
    isQuickEditable: true,
 ...
 * Also, the widget support the factor conversion as the *floatFactor* widget (Range values
 * should be the result of the conversion).
 **/
var FieldFloatToggle = AbstractField.extend({
    supportedFieldTypes: ['float'],
    formatType: 'floatFactor',
    className: 'o-field-float-toggle',
    tagName: 'span',
    events: {
        click: '_onClick'
    },
    ...
    init: function () {
        ...
        this.formatType = 'floatFactor';

        // force the button to work in readonly mode
        if (this.mode === 'edit' || this.nodeOptions.forceButton) {
            this.tagName = 'button';
        }
    ...
    _getDisplayedValue: function () {
        ...
        return fieldUtils.parse['float'](usrFormatValue);
    },
    /**
     * Formats the HTML input tag for edit mode and stores selection status.
     *
    ...
    _onClick: function(ev) {
        ...
        if (this.mode === 'edit' || this.nodeOptions.forceButton) {
            ev.stopPropagation();
            var nextVal = this._nextValue();
            nextVal = fieldUtils.format['float'](nextVal);
            this._setValue(nextVal); // will be parsed in _setValue
        }
    },
    /**
...
var FieldPercentage = FieldFloat.extend({
    className: 'o-field-float-percentage o-field-number',
...
var ListFieldText = FieldText.extend({
    ...
    init: function () {
        this._super.apply(this, arguments);
        this.autoResizeOptions.minHeight = 0;
    },
});
...
var HandleWidget = AbstractField.extend({
    ...
    noLabel: true,
    className: 'o-row-handle fa fa-sort ui-sortable-handle',
    widthInList: '33px',
    tagName: 'span',
    supportedFieldTypes: ['integer'],
...
var FieldEmail = InputField.extend({
    ...
    _renderReadonly: function () {
        if (this.value) {
            this.el.innerHTML = '';
            this.el.classList.add("o-form-uri", "o-text-overflow");
...
var FieldPhone = FieldEmail.extend({
    ...
    _renderReadonly: function () {
        ...
        // phone number, but it breaks the o-row mechanism, which is more
        // important right now.
...
var UrlWidget = InputField.extend({
    ...
    init: function () {
        this._super.apply(this, arguments);
        this.tagName = this.mode === 'readonly' ? 'div' : 'input';
        this.websitePath = this.nodeOptions.websitePath || false;
    },
...
var CopyClipboard = {
    ...
    _initClipboard: function () {
        var self = this;
        var $clipboardBtn = this.$('.o-clipboard-button');
...
var TextCopyClipboard = FieldText.extend(CopyClipboard, {
    ...
    className: "o-field-copy",
});

var CharCopyClipboard = FieldChar.extend(CopyClipboard, {
    description: _lt("Copy to Clipboard"),
    clipboardTemplate: 'CopyClipboardChar',
    className: 'o-field-copy o-text-overflow',
});

var URLCopyClipboard = FieldChar.extend(CopyClipboard, {
    description: _lt("Copy to Clipboard"),
    clipboardTemplate: 'CopyClipboardChar',
    className: 'o-field-copy o-text-overflow o-field-copy-url',
    events: _.extend({}, FieldChar.prototype.events, {
        'click': '_onClick',
    }),

    _onClick: function(ev) {
        if(ev.target.className.includes('o-field-copy-url')) {
            ev.stopPropagation();
...
var AbstractFieldBinary = AbstractField.extend({
    events: _.extend({}, AbstractField.prototype.events, {
        'change .o-input-file': 'onFileChange',
        'click .o-select-file-button': function () {
            this.$('.o-input-file').click();
        },
        'click .o-clear-file-button': '_onClearClick',
    }),
    init: function (parent, name, record) {
        this._super.apply(this, arguments);
        this.fields = record.fields;
        this.useFileAPI = !!window.FileReader;
        this.maxUploadSize = session.maxFileUploadSize || 128 * 1024 * 1024;
        ...
        if (!this.useFileAPI) {
            ...
            $(window).on(this.fileuploadId, function () {
                var args = [].slice.call(arguments).slice(1);
                self.onFileUploaded.apply(self, args);
            });
        }
    },
    destroy: function () {
    ...
    onFileChange: function (e) {
        ...
        if ((this.useFileAPI && fileNode.files.length) || (!this.useFileAPI && $(fileNode).val() !== '')) {
            if (this.useFileAPI) {
                var file = fileNode.files[0];
                if (file.size > this.maxUploadSize) {
                    var msg = _t("The selected file exceed the maximum file size of %s.");
                    this.displayNotification({ title: _t("File upload"), message: _.str.sprintf(msg, utils.humanSize(this.maxUploadSize)), type: 'danger' });
                    return false;
                }
            ...
            this.$('.o-form-binary-progress').show();
            this.$('button').hide();
        }
    },
    onFileUploaded: function (size, name) {
        if (size === false) {
        ...
        this.$('.o-form-binary-progress').hide();
        this.$('button').show();
    },
    onFileUploadedAndValid: function (size, name, contentType, fileBase64) {
        this.setFilename(name);
        this._setValue(fileBase64);
        this._render();
    },
    /**
...
var FieldBinaryImage = AbstractFieldBinary.extend({
     ...
     * @param {string} resId   id of the record
     * @param {string} field    name of the image field
     * @param {string} unique   an unique integer for the record, usually __lastUpdate
     * @returns {string} URL of the image
     */
    _getImageUrl: function (model, resId, field, unique) {
        return session.url('/web/image', {
            model: model,
            id: JSON.stringify(resId),
            field: field,
            // unique forces a reload of the image when the record has been updated
            unique: fieldUtils.format.datetime(unique).replace(/[^0-9]/g, ''),
        });
    },
    _render: function () {
        var self = this;
        ...
        if (this.value) {
            if (!utils.isBinSize(this.value)) {
                ...
                var field = this.nodeOptions.previewImage || this.name;
                var unique = this.recordData.__lastUpdate;
                url = this._getImageUrl(this.model, this.resId, field, unique);
            }
        }
    ...
    _renderReadonly: function () {
        ...
        var unique = this.recordData.__lastUpdate;
        var url = this._getImageUrl(this.model, this.resId, 'image1920', unique);
        var $img;
        ...
        if(this.nodeOptions.background)
        {
            ...
            var urlThumb = this._getImageUrl(this.model, this.resId, this.name, unique);
        ...
        if(this.nodeOptions.zoom) {
            var zoomDelay = 0;
            if (this.nodeOptions.zoomDelay) {
                zoomDelay = this.nodeOptions.zoomDelay;
            }
...
var FieldBinaryFile = AbstractFieldBinary.extend({
    ...
    init: function () {
        this._super.apply(this, arguments);
        this.filenameValue = this.recordData[this.attrs.filename];
    },
    _renderReadonly: function () {
        var visible = !!(this.value && this.resId);
        this.$el.empty().css('cursor', 'not-allowed');
        this.doToggle(visible);
        if (visible) {
            this.$el.css('cursor', 'pointer')
                    .text(this.filenameValue || '')
                    .prepend($('<span class="fa fa-download"/>'), ' ');
        }
    },
    _renderEdit: function () {
        if (this.value) {
            this.$el.children().removeClass('o-hidden');
            this.$('.o-select-file-button').first().addClass('o-hidden');
            this.$('.o-input').eq(0).val(this.filenameValue || this.value);
        } else {
            this.$el.children().addClass('o-hidden');
            this.$('.o-select-file-button').first().removeClass('o-hidden');
        }
    },
    setFilename: function (value) {
        this._super.apply(this, arguments);
        this.filenameValue = value; // will be used in the re-render
        ...
        this.$('.o-save-file-button').prop('disabled', true);
    },
    onSaveAs: function (ev) {
        if (!this.value) {
            ...
            framework.blockUI();
            var filenameFieldname = this.attrs.filename;
            this.getSession().getFile({
                ...
                data: {
                    ...
                    'id': this.resId,
                    'field': this.name,
                    'filenameField': filenameFieldname,
                    'filename': this.recordData[filenameFieldname] || "",
                    'download': true,
                    'data': utils.isBinSize(this.value) ? null : this.value,
                },
...
var FieldPdfViewer = FieldBinaryFile.extend({
    ...
    acceptedFileExtensions: 'application/pdf',
    /**
     * @override
     */
    init: function () {
    ...
    _render: function () {
        var self = this;
        var $pdfViewer = this.$('.o-form-pdf-controls').children().add(this.$('.o-pdfview-iframe'));
        var $selectUpload = this.$('.o-select-file-button').first();
        var $iFrame = this.$('.o-pdfview-iframe');
        ...
        if (this.mode === "readonly" && this.value) {
            ...
            if (this.value) {
                var binSize = utils.isBinSize(this.value);
                $pdfViewer.removeClass('o-hidden');
                $selectUpload.addClass('o-hidden');
                if (binSize) {
                    $iFrame.attr('src', this._getURI());
                }
            } else {
                $pdfViewer.addClass('o-hidden');
                $selectUpload.removeClass('o-hidden');
            }
        }
    ...
    onFileChange: function (ev) {
        ...
        if (this.PDFViewerApplication) {
            ...
            this.$('.o-pdfview-iframe').attr('src', this._getURI(fileURI));
        }
    },
    /**
     * Remove the behaviour of onSaveAs in FieldBinaryFile.
     *
     * @override
     * @private
     * @param {MouseEvent} ev
...
var PriorityWidget = AbstractField.extend({
    ...
    onAttachCallback() {
        ...
        if (self.viewType === "form") {
            ...
            core.bus.trigger("setLegacyCommand", "web.PriorityWidget.setPriority", getCommandDefinition);
        }
    },

    onDetachCallback() {
        core.bus.trigger("removeLegacyCommand", "web.PriorityWidget.setPriority");
    },
    ...
    _render: function () {
        var self = this;
        var indexValue = this.value ? _.findIndex(this.field.selection, function (v) {
            return v[0] === self.value;
        }) : 0;
        this.$el.empty();
        this.emptyValue = this.field.selection[0][0];
        ...
        _.each(this.field.selection.slice(1), function (choice, index) {
            ...
            self.$el.append(self._renderStar(tag, indexValue >= index + 1, index + 1, choice[1], indexValue));
        });
    },
    ...
    _onMouseOver: function (event) {
        clearTimeout(this.hoverTimer);
        this.$('.o-priority-star').removeClass('fa-star-o').addClass('fa-star');
    ...
    _render: function () {
        if (this.value) {
            this.$el.empty().append($('<img>/', {
                ...
                title: this.value.data.displayName,
                alt: _t("Image")
            }));
        }
    }
...
var StateSelectionWidget = AbstractField.extend({
    ...
    onAttachCallback() {
        ...
        if (self.viewType === "form") {
            ...
            core.bus.trigger("setLegacyCommand", "web.StateSelectionWidget.setKanbanState", getCommandDefinition);
        }
    },

    onDetachCallback() {
        core.bus.trigger("removeLegacyCommand", "web.StateSelectionWidget.setKanbanState");
    },
    //--------------------------------------------------------------------------
    // Private
    //--------------------------------------------------------------------------
    ...
    _prepareDropdownValues: function () {
        var self = this;
        var _data = [];
        var currentStageId = self.recordData.stageId && self.recordData.stageId[0];
        var stageData = {
            id: currentStageId,
            legendNormal: this.recordData.legendNormal || undefined,
            legendBlocked : this.recordData.legendBlocked || undefined,
            legendDone: this.recordData.legendDone || undefined,
        };
        _.map(this.field.selection || [], function (selectionItem) {
            var value = {
                'name': selectionItem[0],
                'tooltip': selectionItem[1],
            };
            if (selectionItem[0] === 'normal') {
                value.stateName = stageData.legendNormal ? stageData.legendNormal : selectionItem[1];
            } else if (selectionItem[0] === 'done') {
                value.stateClass = 'o-status-green';
                value.stateName = stageData.legendDone ? stageData.legendDone : selectionItem[1];
            } else {
                value.stateClass = 'o-status-red';
                value.stateName = stageData.legendBlocked ? stageData.legendBlocked : selectionItem[1];
            }
            _data.push(value);
        });
        return _data;
    ...
    _render: function () {
        ...
        this.$('.o-status')
            .removeClass('o-status-red o-status-green')
            .addClass(currentState.stateClass)
            .prop('specialclick', true)
            .parent().attr('title', currentState.stateName)
            .attr('aria-label', this.string + ": " + currentState.stateName);
...
const ListStateSelectionWidget = StateSelectionWidget.extend({
    ...
    _render() {
        ...
        const hideLabel = utils.toBoolElse(this.nodeOptions.hideLabel || '', false);
        if (!hideLabel) {
            const states = this._prepareDropdownValues();
            const currentState = states.find(state => state.name === this.value) || states[0];
            const statusEL = this.el.querySelector('.o-status-label');
            if (statusEL) {
                statusEL.innerText = currentState.stateName;
            } else {
                const labelEL = Object.assign(document.createElement('span'), {
                    innerText: currentState.stateName,
                    className: 'o-status-label align-middle',
                });
...
var BooleanToggle = FieldBoolean.extend({
    ...
    className: FieldBoolean.prototype.className + ' o-boolean-toggle',
    isQuickEditable: true,
    events: {
        'click': '_onClick'
    },
     ...
     * fa-times-circle
     *
     * The booleanToggle should only be disabled when there is a readonly modifier
...
var StatInfo = AbstractField.extend({
    ...
    _render: function () {
        ...
        if (! this.attrs.nolabel) {
            if (this.nodeOptions.labelField && this.recordData[this.nodeOptions.labelField]) {
                options.text = this.recordData[this.nodeOptions.labelField];
            } else {
                options.text = this.string;
            }
        }
        this.$el.html(qweb.render("StatInfo", options));
        this.$el.addClass('o-stat-info');
    },
});
...
var FieldPercentPie = AbstractField.extend({
     ...
     */
    start: function () {
        this.$leftMask = this.$('.o-mask').first();
        this.$rightMask = this.$('.o-mask').last();
        this.$pieValue = this.$('.o-pie-value');
        return this._super();
    },
    ...
    _render: function () {
        ...
        this.$rightMask.toggleClass('o-full', degValue >= 180);
 ...
 * - currentValue: get the currentValue from the field that must be present in the view
 * - maxValue: get the maxValue from the field that must be present in the view
 * - editMaxValue: boolean if the maxValue is editable
...
var FieldProgressBar = AbstractField.extend({
    ...
    init: function () {
        ...
        this.editableReadonly = !!this.nodeOptions.editableReadonly;
        // "hard" readonly
        this.readonly = this.nodeOptions.readonly || !this.nodeOptions.editable;

        this.canWrite = !this.readonly && (
            this.mode === 'edit' ||
            (this.editableReadonly && this.mode === 'readonly') ||
            (this.viewType === 'kanban') // Keep behavior before commit
        );

        // Boolean to toggle if we edit the numerator (value) or the denominator (maxValue)
        this.editMaxValue = !!this.nodeOptions.editMaxValue;
        this.maxValue = this.recordData[this.nodeOptions.maxValue] || 100;
        ...
        this.editOnClick = this.enableBarAsInput && this.mode === 'readonly' && !this.editMaxValue;
    ...
    _render: function () {
        ...
        if (this.canWrite) {
            if (this.editOnClick) {
                this.$el.on('click', '.o-progress', function (e) {
                    var $target = $(e.currentTarget);
                    var numValue = Math.floor((e.pageX - $target.offset().left) / $target.outerWidth() * self.maxValue);
                    self.onUpdate(numValue);
                    self._renderValue();
                });
            } else {
                this.$el.on('click', function () {
                    if (!self.writeMode) {
                        var $input = $('<input>', {type: 'text', class: 'o-progressbar-value o-input'});
                        $input.on('blur', self.onChangeInput.bind(self));
                        self.$('.o-progressbar-value').replaceWith($input);
                        self.writeMode = true;
                        self._renderValue();
                    }
                });
    ...
    onUpdate: function (value) {
        if (this.editMaxValue) {
            ...
            this._isValid = true;
            var changes = {};
            changes[this.nodeOptions.maxValue] = this.maxValue;
            this.triggerUp('fieldChanged', {
                dataPointID: this.dataPointID,
                changes: changes,
            });
    ...
    onChangeInput: function (e) {
        ...
        try {
            ...
            parsedValue = fieldUtils.parse.float($input.val());
        } catch (error) {
        ...
        if (parsedValue !== undefined) {
            if (e.type === 'input') { // ensure what has just been typed in the input is a number
                ...
                var $div = $('<div>', {class: 'o-progressbar-value'});
                this.$('.o-progressbar-value').replaceWith($div);
                this.writeMode = false;

                this.onUpdate(parsedValue);
                this._renderValue();
            }
        }
    },
    ...
    _renderValue: function (v) {
        ...
        this.$('.o-progress').toggleClass('o-progress-overflow', value > maxValue)
            .attr('aria-valuemin', '0')
            .attr('aria-valuemax', maxValue)
            .attr('aria-valuenow', value);
        this.$('.o-progressbar-complete').css('width', widthComplete + '%');

        if (!this.writeMode) {
            if (maxValue !== 100) {
                this.$('.o-progressbar-value').text(utils.humanNumber(value) + " / " + utils.humanNumber(maxValue));
            } else {
                this.$('.o-progressbar-value').text(utils.humanNumber(value) + "%");
            }
        } else if (isNaN(v)) {
            this.$('.o-progressbar-value').val(this.editMaxValue ? maxValue : value);
            this.$('.o-progressbar-value').focus().select();
        }
    },
    /**
    ...
    _reset: function () {
        this._super.apply(this, arguments);
        var newMaxValue = this.recordData[this.nodeOptions.maxValue];
        this.maxValue =  newMaxValue !== undefined ? newMaxValue : this.maxValue;
    },
    isSet: function () {
        return true;
    },
...
var FieldToggleBoolean = AbstractField.extend({
    ...
    _render: function () {
        this.$('i')
            .toggleClass('o-toggle-button-success', !!this.value)
...
var JournalDashboardGraph = AbstractField.extend({
    className: "o-dashboard-graph",
    jsLibs: [
        '/web/static/lib/Chart/Chart.js',
    ],
    init: function () {
        this._super.apply(this, arguments);
        this.graphType = this.attrs.graphType;
     ...
     * flickering). We here use the onAttachCallback hook, called when the
    ...
    _getLineChartConfig: function () {
        ...
        var borderColor = this.data[0].isSampleData ? '#dddddd' : '#875a7b';
        var backgroundColor = this.data[0].isSampleData ? '#ebebeb' : '#dcd0d9';
        return {
            type: 'line',
            data: {
                labels: labels,
...
var FieldDomain = AbstractField.extend({
    ...
    events: _.extend({}, AbstractField.prototype.events, {
        "click .o-domain-show-selection-button": "_onShowSelectionButtonClick",
        "click .o-field-domain-dialog-button": "_onDialogEditButtonClick",
        "click .o-refresh-count": "_onRefreshCountClick",
    }),
    customEvents: _.extend({}, AbstractField.prototype.customEvents, {
        domainChanged: "_onDomainSelectorValueChange",
        domainSelected: "_onDomainSelectorDialogValueChange",
    ...
    init: function () {
        ...
        this.inDialog = !!this.nodeOptions.inDialog;
        this.fsFilters = this.nodeOptions.fsFilters || {};

        this.className = "o-field-domain";
        if (this.mode === "edit") {
            this.className += " o-edit-mode";
        }
        if (!this.inDialog) {
            this.className += " o-inline-mode";
        }
    ...
    /**
     * We use the onAttachCallback hook here when widget is attached to the DOM, so that
    ...
    onAttachCallback() {
        if (this.domainSelector && !this.inDialog) {
            this.domainSelector.onAttachCallback();
        }
    },
     ...
     * we perform a searchCount with that domain.
     *
     * @override
     ...
     _fetchCount(force = false) {
        ...
        this.lastCountFetchProm = new Promise((resolve) => {
            this._rpc({
                ...
                reason.event.preventDefault(); // prevent traceback (the searchCount might be intended to break)
    ...
    /**
     * Called when the "Edit domain" button is clicked (when using the inDialog
    ...
    /**
     * Stops the propagation of the 'openRecord' event, as we don't want the
 ...
 * for editing XML and Javascript.
 */
...
var FieldColor = AbstractField.extend({
    template: 'FieldColor',
    events: _.extend({}, AbstractField.prototype.events, {
        'click .o-field-color': '_onColorClick',
    }),
    customEvents: _.extend({}, AbstractField.prototype.customEvents, {
    ...
    */
    _render: function () {
        this.$('.o-field-color').data('value', this.value)
...
var FieldColorPicker = FieldInteger.extend({
    ...
    _renderReadonly: function () {
        ...
        this.$el.html(qweb.render('ColorPickerReadonly', { activeColor: this.value, nameColor: selectedColorName }));

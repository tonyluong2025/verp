verp.define('web.FieldWrapper', function (require) {
    "use strict";
    ...
    class FieldWrapper extends ComponentWrapper {
        constructor() {
            ...
            this._data.resId = record.resId;
            this._data.model = record.model;
            this._data.mode = options.mode || "readonly";
            this._data.formatType = this._data.attrs.widget in fieldUtils.format ?
         ...
         * not the real field Component, which triggers the 'fieldChanged'

verp.define('web.public.lazyloader', function (require) {
'use strict';
     ...
     * working (those sections should be marked with the 'o-wait-lazy-js' class).
     *
     * @see stopWaitingLazy
     */
    function waitLazy() {
        ...
        var lazyEls = document.querySelectorAll('.o-wait-lazy-js');
        ...
        document.body.classList.add('o-lazy-js-waiting');
    }
    /**
     * Unblocks the DOM sections blocked by @see waitLazy and removes the related
     * 'o-wait-lazy-js' class from the whole DOM.
     */
    function stopWaitingLazy() {
        ...
        for (var i = 0; i < lazyEls.length; i++) {
            ...
            element.classList.remove('o-wait-lazy-js');
        }

        document.body.classList.remove('o-lazy-js-waiting');
    }

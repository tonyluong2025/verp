/** @verp-module alias=web.PivotView **/
    ...
    const PivotView = AbstractView.extend({
        ...
        init: function (viewInfo, params) {
            ...
            const colGroupBys = []; // Store the defined groupby used on cols
            const rowGroupBys = []; // Store the defined groupby used on rows
            ...
            this.arch.children.forEach(field => {
                ...
                if (field.attrs.invisible && vj.eval(field.attrs.invisible)) {
                ...
                // readGroup method.  In this case, the pivot view could work, and
            ...
            if ((!activeMeasures.length) || this.arch.attrs.displayQuantity) {
            ...
            this.loadParams.defaultOrder = params.defaultOrder || this.arch.attrs.defaultOrder;

            const disableLinking = !!(this.arch.attrs.disableLinking &&
                                        JSON.stringify(this.arch.attrs.disableLinking));

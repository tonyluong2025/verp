verp.define('web.searchUtils', function (require) {
    "use strict";
    ...
    const DEFAULT_PERIOD = 'thisMonth';
    const QUARTERS = {
    ...
    const MONTH_OPTIONS = {
        thisMonth: {
            id: 'thisMonth', groupNumber: 1, format: 'MMMM',
            addParam: {}, granularity: 'month',
        },
        lastMonth: {
            id: 'lastMonth', groupNumber: 1, format: 'MMMM',
            addParam: { months: -1 }, granularity: 'month',
        },
        antepenultimateMonth: {
            id: 'antepenultimateMonth', groupNumber: 1, format: 'MMMM',
            addParam: { months: -2 }, granularity: 'month',
        },
    };
    const QUARTER_OPTIONS = {
        fourthQuarter: {
            id: 'fourthQuarter', groupNumber: 1, description: QUARTERS[4].description,
            setParam: { quarter: 4 }, granularity: 'quarter',
        },
        thirdQuarter: {
            id: 'thirdQuarter', groupNumber: 1, description: QUARTERS[3].description,
            setParam: { quarter: 3 }, granularity: 'quarter',
        },
        secondQuarter: {
            id: 'secondQuarter', groupNumber: 1, description: QUARTERS[2].description,
            setParam: { quarter: 2 }, granularity: 'quarter',
        },
        firstQuarter: {
            id: 'firstQuarter', groupNumber: 1, description: QUARTERS[1].description,
            setParam: { quarter: 1 }, granularity: 'quarter',
        },
    };
    const YEAR_OPTIONS = {
        thisYear: {
            id: 'thisYear', groupNumber: 2, format: 'YYYY',
            addParam: {}, granularity: 'year',
        },
        lastYear: {
            id: 'lastYear', groupNumber: 2, format: 'YYYY',
            addParam: { years: -1 }, granularity: 'year',
        },
        antepenultimateYear: {
            id: 'antepenultimateYear', groupNumber: 2, format: 'YYYY',
    ...
    const COMPARISON_OPTIONS = {
        previousPeriod: {
            description: _lt("Previous Period"), id: 'previousPeriod',
        },
        previousYear: {
            description: _lt("Previous Year"), id: 'previousYear', addParam: { years: -1 },
        },
    };
    const PER_YEAR = {
        year: 1,
    ...
    function constructDateDomain(
        ...
        const domain = vjUtils.assembleDomains(ranges.map(range => range.domain), 'OR');

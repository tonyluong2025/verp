...
var ListView = BasicView.extend({
    ...
    _extractGroup: function (node) {
        var innerView = this.fields[node.attrs.name].views.groupby; // Tony must check innerView == undefined => "TypeError: Cannot read properties of null (reading 'documentElement')"

/** @verp-module alias=web.ListConfirmDialog **/
...
const ListConfirmDialog = Dialog.extend(WidgetAdapterMixin, {
    ...
    init: function (parent, record, params, options) {
        options = Object.assign({}, options, {
            ...
            buttons: options.buttons || [{
                ...
                classes: 'btn-primary',
                close: true,
                click: options.confirmCallback,
            }, {
                text: _t("Cancel"),
                close: true,
                click: options.cancelCallback,
            }],
            onForceClose: options.cancelCallback,
    ...
    start: function () {
        this.fieldWidgets.forEach(({ fieldWidget }) => {
            this.$content.find(`.o-changes-widget[data-name=${fieldWidget.name}]`).replaceWith(fieldWidget.$el);

verp.define('web.Popover', function (require) {
    'use strict';
    ...
    class Popover extends Component {
        ...
        _compute() {
            ...
            possiblePositions.forEach((pos) => {
                this.popoverRef.el.classList.remove(`o-popover--${pos}`);
            });

            if (position) {
                // apply the preferred found position that fits the viewport
                this.popoverRef.el.classList.add(`o-popover--${position.name}`);
            } else {
                ...
                this.popoverRef.el.classList.add(`o-popover--${this.props.position}`);
            }
        }

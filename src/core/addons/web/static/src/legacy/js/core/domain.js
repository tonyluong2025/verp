...
var Domain = collections.Tree.extend({
     ...
     *            * a string representation of the Javascript prefix-array
    ...
    /**
     * @returns {string} representation of the Javascript prefix-array
     *                   representation of the domain
     */
    toString: function () {
     ...
     * representation of the Javascript prefix-array representation of this domain.
     *
     * @static
    ...
    /**
     * Converts a string representation of the Javascript prefix-array
    ...
    stringToArray: function (domain, evalContext) {
        ...
        return vjUtils.eval("domain", domain ? domain.replace(/%%/g, '%') : "[]", evalContext);
    },
    /**
    ...
    /**
     * Converts JS prefix-array representation of a domain to a javascript condition
     *
     * @static
     * @param {Array} domain
     * @returns {string}
    ...
    /**
     * Converts javascript condition to a JS prefix-array representation of a domain
     *
     * @static
    ...
    conditionToDomain: function (condition) {
        ...
        var ast = vj.parse(vj.tokenize(condition));

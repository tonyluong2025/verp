...
import registry from 'web.viewRegistry';
...
var Controller = AbstractController.extend({
    ...
    _update: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            // area
            var $cpButtons = self.renderer.$('nav.o-qweb-cp-buttons');
            $cpButtons.children().appendTo(self.$buttons.empty());
            $cpButtons.remove();
        });
    },
...
var QWebView = AbstractView.extend({
    ...
    init: function (viewInfo, params) {
        this._super.apply(this, arguments);
        this.loadParams.viewId = viewInfo.viewId;
    }
});

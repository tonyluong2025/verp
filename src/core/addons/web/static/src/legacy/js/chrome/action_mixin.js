verp.define('web.ActionMixin', function (require) {
    "use strict";
     ...
     * ir.action.actwindow).  However, some actions are 'client actions'.  They
    ...
    const ActionMixin = Object.assign({}, WidgetAdapterMixin, {
         ...
         * This template has a special zone ('.o-content') where the content should
        ...
        /**
         * Events built by and managed by Verp Framework
         *
         ...
         */
        customEvents: {
            getControllerQueryParams: '_onGetOwnedQueryParams',
        },
         ...
         * ignored ('action', 'activeId', 'activeIds' and 'title', for all
         * actions, and 'model' and 'viewType' for actwindow actions).
         *
         * @returns {Object}
         */
        getState: function () {
         ...
         * the controlPanelWrapper before render it. The key 'cpContent'
        ...
        updateControlPanel: async function (newProps = {}) {
            ...
            if ('cpContent' in props) {
                // cpContent has been updated: refresh it.
                this.controlPanelProps.cpContent = Object.assign({},
                    this.controlPanelProps.cpContent,
                    props.cpContent,
                );
                delete props.cpContent;
            }
            // Update props state

verp.define('web.AbstractFieldOwl', function (require) {
    "use strict";
    ...
    class AbstractField extends owl.Component {
        ...
        __patch() {
            ...
            this.el.classList.add('o-field-widget');
            this.el.classList.toggle('o-quick-editable', this._canQuickEdit);
            return res;
        }
        /**
         * @async
         ...
         */
        get formatType() {
            return this.attrs.widget in fieldUtils.format ?
        ...
        /**
         * The resId of the record in database.
         * When the user is creating a new record, there is no resId.
         * When the record will be created, the field component will
         * be destroyed (when the form view switches to readonly mode) and a
         * new component with a resId in mode readonly will be created.
         *
         * @returns {Number}
         */
        get resId() {
         ...
         */
        removeInvalidClass() {
            this.el.classList.remove('o-field-invalid');
         ...
         */
        setInvalidClass() {
            this.el.classList.add('o-field-invalid');
        ...
        _applyDecorations() {
            for (const dec of this.attrs.decorations || []) {
                const isToggled = vj.VJ_isTrue(
                vj.evaluate(dec.expression, this.record.evalContext)
                );
        ...
        _formatValue(value) {
            ...
            return fieldUtils.format[this.formatType](value, this.field, options);
        }
        /**
        ...
        _onKeydown(ev) {
            switch (ev.which) {
                ...
                case $.ui.keyCode.ENTER:
                    ...
                    ev.preventDefault();
                    ev.stopPropagation();
                    this.trigger('navigation-move', {direction: 'nextLine'});
                    break;

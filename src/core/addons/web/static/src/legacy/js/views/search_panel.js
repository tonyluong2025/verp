/** @verp-module alias=web.searchpanel **/
    ...
    class SearchPanel extends Component {
        ...
        _updateGroupHeadersChecked() {
            const groups = this.el.querySelectorAll(":scope .o-searchpanel-filter-group");
            for (const group of groups) {
                const header = group.querySelector(":scope .o-searchpanel-group-header input");
                const vals = [...group.querySelectorAll(":scope .o-searchpanel-filter-value input")];

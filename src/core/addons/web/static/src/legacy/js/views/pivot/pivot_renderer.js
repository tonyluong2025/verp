/** @verp-module alias=web.PivotRenderer **/
    ...
    class PivotRenderer extends OwlAbstractRenderer {
        ...
        _getFormattedValue(cell) {
            ...
            const formatter = fieldUtils.format[type];
        ...
        _getFormattedVariation(cell) {
            ...
            return isNaN(value) ? '-' : fieldUtils.format.percentage(value, this.props.fields[cell.measure]);
        }
         ...
         */
        _updateTooltip() {
            $(this.el).find('.o-pivot-header-cell-opened, .o-pivot-header-cell-closed').tooltip();
        }
        ...
        _onHeaderClick(cell, type) {
            ...
            this.trigger(cell.isLeaf ? 'closedHeaderClick' : 'openedHeaderClick', { cell, type });
        }
        ...
        _onMouseEnter(ev) {
            ...
            this.el.querySelectorAll('td:nth-child(' + (index + 1) + ')').forEach(elt => elt.classList.add('o-cell-hover'));
        }
         ...
         */
        _onMouseLeave() {
            this.el.querySelectorAll('.o-cell-hover').forEach(elt => elt.classList.remove('o-cell-hover'));
        }
    }

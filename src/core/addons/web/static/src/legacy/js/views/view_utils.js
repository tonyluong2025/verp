/** @verp-module alias=web.viewUtils **/
...
var viewUtils = {
    /**
     * Since a date field can have a granularity in a groupby (dateField:granularity),
    ...
    parseArch: function (arch) {
        ...
        return utils.xmlToJson(doc, stripWhitespaces);
    },
    /**

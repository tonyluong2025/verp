verp.define('web.DatePickerOwl', function (require) {
    "use strict";
    ...
    class DatePicker extends Component {
        constructor() {
            ...
            this.datePickerId = `o-datepicker-${datePickerId++}`;
        ...
        _formatDate(date) {
            try {
                return fieldUtils.format[this.typeOfDate](date, null, { timezone: false });
            } catch (err) {
                return false;
            }
        }
        ...
        _parseInput(inputValue) {
            try {
                return fieldUtils.parse[this.typeOfDate](inputValue, null, { timezone: false });
            } catch (err) {
                return false;
            }
        }

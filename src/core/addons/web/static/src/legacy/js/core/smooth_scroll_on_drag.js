verp.define('web/static/src/js/core/smooth_scroll_on_drag.js', function (require) {
"use strict";
...
const SmoothScrollOnDrag = Class.extend(mixins.ParentedMixin, {
    ...
    init(parent, $element, $scrollTarget, options = {}) {
        ...
        if (!this.options.jQueryDraggableOptions.cursorAt) {
            this.$element.on('mousedown.smoothScroll', this._onElementMouseDown.bind(this));
        }

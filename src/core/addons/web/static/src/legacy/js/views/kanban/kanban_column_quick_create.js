verp.define('web.kanbanColumnQuickCreate', function (require) {
"use strict";
...
var ColumnQuickCreate = Widget.extend({
    ...
    events: {
        'click .o-quick-create-folded': '_onUnfold',
        'click .o-kanban-add': '_onAddClicked',
        'click .o-kanban-examples': '_onShowExamples',
        'keydown': '_onKeydown',
     ...
     */
    start: function () {
        this.$quickCreateFolded = this.$('.o-quick-create-folded');
        this.$quickCreateUnfolded = this.$('.o-quick-create-unfolded');
    ...
    toggleFold: function () {
        ...
        if (!this.folded) {
            this.$input.focus();
            this.triggerUp('scrollTo', {selector: '.o-column-quick-create'});
        }
    },
    ...
    _add: function () {
        ...
        this.$input.val('');
        this.triggerUp('quickCreateAddColumn', {value: value});
        this.$input.focus();
    },
    /**
    ...
    _update: function () {
        ...
        this.triggerUp('quickCreateColumnUpdated');
    },
            ...
            buttons: [{
                ...
                click: function () {
                    ...
                    activeExample.columns.forEach(column => {
                        self.triggerUp('quickCreateAddColumn', { value: column.toString(), foldQuickCreate: true });
                    });
                }
            }, {

verp.define('web.jquery.extensions', function () {
'use strict';
...
$.fn.extend({
    ...
    /**
     * Makes DOM elements bounce the way Verp decided it.
     *
     * @param {string} [extraClass]
     */
    verpBounce: function (extraClass) {
        for (const el of this) {
            el.classList.add('o-catch-attention', extraClass);
            setTimeout(() => el.classList.remove('o-catch-attention', extraClass), 400);
        }
        return this;
    },
    /**

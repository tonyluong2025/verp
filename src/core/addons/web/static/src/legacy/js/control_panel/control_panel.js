verp.define('web.ControlPanel', function (require) {
    "use strict";
    ...
    /**
     * TODO: remove this whole mechanism as soon as `cpContent` is completely removed.
     * Extract the 'cpContent' key of the given props and return them as well as
     ...
     * given in `props.cpContent` in a related section:
     *      $buttons -> [Buttons]
    ...
    class ControlPanel extends Component {
        ...
        /**
         * Attach additional content extracted from the props 'cpContent' key, if any.
         * @private
         */

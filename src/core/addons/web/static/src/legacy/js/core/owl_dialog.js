verp.define('web.OwlDialog', function (require) {
    "use strict";
    ...
    class Dialog extends Component {
        ...
        mounted() {
            ...
            this.env.bus.on('closeDialogs', this, this._close);
            ...
            this.env.bus.trigger("owlDialogMounted", this);
        }

        willUnmount() {
            // Notifies new webclient to adjust UI active element
            this.env.bus.trigger("owlDialogWillunmount", this);

            this.env.bus.off('closeDialogs', this, this._close);
        ...
        static display(dialog) {
            ...
            if (activeDialog) {
                ...
                activeDialogEl.classList.add('o-inactive-modal');
        ...
        static hide(dialog) {
            ...
            if (lastDialog) {
                ...
                const modalEl = lastDialog.modalRef ?
                    ...
                    // Legacy dialog
                    lastDialog.$modal[0];
                modalEl.classList.remove('o-inactive-modal');

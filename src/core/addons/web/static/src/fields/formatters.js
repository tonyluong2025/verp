 ...
 *   fieldsGet for example).  It may contain a description of the number of
 ...
 * @param {float|false} value the value that should be formatted
 * @param {Object} [field]
 *   a description of the field (returned by fieldsGet for example). It may
 *   contain a description of the number of digits that should be used.
 * @param {Object} [options]
 *   additional options to override the values in the javascript description of the
 *   field.
 ...
 *   the currency id (ignored if options.currencyId).
 *   Note: if not given it will default to the field "currencyField" value or
 *   on "currencyId".
...
export function formatMonetary(value, options = {}) {
    ...
    if (!currencyId && options.data) {
        const currencyField =
            ...
            (options.field && options.field.currencyField) ||
            "currencyId";
...
registry
    ...
    .add("floatFactor", formatFloatFactor)
    .add("floatTime", formatFloatTime)

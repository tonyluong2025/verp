...
export class GraphView extends Component {
    ...
    getContext() {
        ...
        return {
            ...
            graphMode: mode,
            graphGroupbys: groupby.map((gb) => gb.spec),
        };
    }
...
class GraphSearchModel extends SearchModel {
    ...
    _getSearchItemGroupBys(activeItem) {
        ...
        if (!this.preparingIrFilterDescription && type === "favorite" && context.graphGroupbys) {
            return context.graphGroupbys;
        }
...
GraphView.displayName = _lt("Graph");

...
export class PivotView extends Component {
    ...
    getContext() {
        return {
            pivotMeasures: this.model.metaData.activeMeasures,
            pivotColumnGroupby: this.model.metaData.fullColGroupBys,
            pivotRowGroupby: this.model.metaData.fullRowGroupBys,
        };
    }
...
class PivotSearchModel extends SearchModel {
    ...
    _getSearchItemGroupBys(activeItem) {
        ...
        if (
            ...
            type === "favorite" &&
            context.pivotRowGroupby
        ) {
            return context.pivotRowGroupby;
        }
...
PivotView.displayName = _lt("Pivot");

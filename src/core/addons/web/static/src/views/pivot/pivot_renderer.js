...
export class PivotRenderer extends Component {
    ...
    onMouseEnter(ev) {
        ...
        if (ev.currentTarget.tagName === "TH") {
            if (
                !ev.currentTarget.classList.contains("o-pivot-origin-row") &&
        ...
        this.el
            ...
            .forEach((elt) => elt.classList.add("o-cell-hover"));
    }
    /**
    ...
    onMouseLeave() {
        this.el
            .querySelectorAll(".o-cell-hover")
            .forEach((elt) => elt.classList.remove("o-cell-hover"));
    }
}

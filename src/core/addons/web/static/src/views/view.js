...
export class View extends Component {
    ...
    async willStart() {
        ...
        const subType = rootNode.getAttribute("jsClass");
        const bannerRoute = rootNode.getAttribute("bannerRoute");
 ...
 *
  ...
  Related to config/display/layout
      ...
      withSearchBar // 'noBreadcrumbs' in context ? !context.noBreadcrumbs : true,
      withSearchPanel // this.withSearchPanel from constructor
      searchpanel // = params.searchpanel or context.searchpanel

  Prepare for concrete view ???
      activeActions

  Do stuff in View comp ???
      banner // from arch = this.arch.attrs.bannerRoute
*/

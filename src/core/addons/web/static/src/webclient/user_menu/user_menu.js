...
const userMenuRegistry = registry.category("userMenuitems");
...
export class UserMenu extends Component {
    setup() {
        ...
        this.source = `${origin}/web/image?model=res.users&field=avatar128&id=${userId}`;
    }
...
registry.category("systray").add("web.userMenu", systrayItem, { sequence: 0 });

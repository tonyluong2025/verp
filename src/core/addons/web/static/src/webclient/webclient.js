...
export class WebClient extends Component {
    setup() {
        ...
        this.title.setParts({ zopenerp: "Verp" }); // zopenerp is easy to grep
    ...
    mounted() {
        // the chat window and dialog services listen to 'webClientReady' event in
    ...
    async loadRouterState() {
        ...
        let menuId = Number(this.router.current.hash.menuId || 0);
